...
* [Solidity](https://github.com/bkrem/awesome-solidity) ⭐ 7,050 | 🐛 16 | 📅 2026-09-14 - Curated list of awesome Solidity resources, libraries, tools and more.
...
* [Web3 Security](https://github.com/Anugrahsr/Awesome-web3-Security) ⭐ 1,623 | 🐛 16 | 📅 2026-03-01 - Curated list of web3 security materials and resources for pentesters and bug hunters.
...
* [Foundry](https://github.com/crisgarner/awesome-foundry) ⭐ 1,187 | 🐛 6 | 📅 2024-10-17 - Curated list of awesome Foundry resources, tutorials, tools and libraries.
* [Account Abstraction](https://github.com/4337Mafia/awesome-account-abstraction) ⭐ 1,020 | 🐛 803 | 📅 2026-06-09 - Collection of account abstraction resources.
...
* [RPC Nodes](https://github.com/arddluma/awesome-list-rpc-nodes-providers) ⭐ 915 | 🐛 1,295 | 📅 2025-08-28 - Curated list of awesome Node providers and public RPC endpoints.
* [Ethereum](https://github.com/bekatom/awesome-ethereum) ⭐ 911 | 🐛 12 | 📅 2026-08-26 - Awesome Ethereum & Dapps Resources.
...
* [x402](https://github.com/xpaysh/awesome-x402) ⭐ 291 | 🐛 594 | 📅 2026-07-28 - Internet-native payment protocol using HTTP 402 status code for blockchain payments.
...
* [AI × Crypto Tools](https://github.com/FlipZ3ro/awesome-ai-crypto-tools#readme) ⭐ 1 | 🐛 4 | 📅 2026-06-18 - Curated list of AI-powered tools for crypto trading, analysis, security, and development.
...
* [Awesome Web3 Grants](https://github.com/zkprimecapital/awesome-web3-grants) ⭐ 0 | 🐛 0 | 📅 2026-09-18 - Curated list of active web3 grant programs: ecosystem foundations, L2s, DeFi DAOs, ZK and VC grant programs.

## Reference

* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,952 | 🐛 56 | 🌐 Wikitext | 📅 2026-09-22 - Bitcoin Improvement Proposals.
...
* [evm.codes](https://www.evm.codes) - An interactive reference to Ethereum Virtual Machine Opcodes ([source code](https://github.com/comitylabs/evm.codes) ⭐ 827 | 🐛 52 | 🌐 TypeScript | 📅 2026-09-18).
...
* [DeFi Developer](https://github.com/OffcierCia/DeFi-Developer-Road-Map) ⭐ 10,832 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-16 - Curated Web3.0 Developer handbook which includes a list of the best tools for DApps, development resources and lifehacks.
...
* [Yul By Example](https://github.com/Perelyn-sama/yul_by_example) ⭐ 251 | 🐛 0 | 🌐 HTML | 📅 2024-08-27 - Basic examples on Yul.
* [Solidity by Example](https://solidity-by-example.org) - Basic examples on Solidity.

### Development Environment

* [Embark](https://github.com/embarklabs/embark) ⭐ 3,765 | 🐛 134 | 🌐 JavaScript | 📅 2024-07-30 - The all-in-one developer platform for building and deploying decentralized applications.
...
* [Ethereum Code Viewer](https://github.com/dethcrypto/ethereum-code-viewer) ⭐ 1,368 | 🐛 23 | 🌐 TypeScript | 📅 2025-09-30 - View source of deployed Ethereum smart contracts in VS Code.
* [Solana Playground](https://github.com/solana-playground/solana-playground) ⭐ 971 | 🐛 116 | 🌐 Rust | 📅 2026-09-22 - Online IDE to quickly develop and deploy Solana programs that runs on web browser.
...
* [Tatum SDK](https://github.com/tatumio/tatum-js) ⭐ 399 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-08 - Tatum SDK is a powerful, feature-rich TypeScript/JavaScript library that streamlines the development of blockchain applications.
...
* [WalletLink](https://github.com/walletlink/walletlink) ⭐ 1,763 | 🐛 92 | 🌐 TypeScript | 📅 2026-09-22 - Open protocol that lets users connect their mobile wallets to your DApp.
...
* [Ophis](https://ophis.fi) - Intent-based DEX aggregator (a CoW Protocol fork) for gasless, MEV-protected swaps across 11 chains, with an MCP server and SDK for AI agents. ([GitHub](https://github.com/ophis-fi/ophis) ⭐ 4 | 🐛 23 | 🌐 Rust | 📅 2026-09-22 · [Docs](https://docs.ophis.fi))
...
* [DAY Protocol](https://dayprotocol.com) - Agent-native non-custodial yield router — wallet-only identity, strategies across Sui/Solana/Base/Arbitrum, Auto Pay residual rails and x402. ([SDK](https://github.com/dayprotocol/sdk) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-21 · [Docs](https://docs.dayprotocol.com))
...
* [ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,715 | 🐛 663 | 🌐 TypeScript | 📅 2026-06-18 - Complete Ethereum wallet implementation and utilities in JavaScript (and TypeScript).
* [js-ipfs](https://github.com/ipfs/js-ipfs) ⚠️ Archived - IPFS implementation in JavaScript.
* [wagmi](https://github.com/wevm/wagmi) ⭐ 6,751 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-07 - React hooks library for Ethereum.
* [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 6,001 | 🐛 54 | 🌐 JavaScript | 📅 2026-02-17 - Bitcoin library for node.js and browsers.
...
* [solana-web3.js](https://github.com/solana-labs/solana-web3.js) ⭐ 2,757 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-22 - Solana Javascript API built on the Solana JSON RPC API.
* [starknet.js](https://github.com/0xs34n/starknet.js) ⭐ 1,255 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-22 - JavaScript library to interact with Starknet.
* [Hashgraph Online Standards SDK](https://github.com/hashgraph-online/standards-sdk) ⭐ 1,223 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-02 - TypeScript SDK for Hedera Consensus Service standards (HCS-1 through HCS-11), enabling decentralized file storage, NFT metadata, and recursive content on Hedera.
...
* [avalanchejs](https://github.com/ava-labs/avalanchejs) ⭐ 357 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-22 - JavaScript Library for interfacing with the Avalanche Platform.
* [sequence.js](https://github.com/0xsequence/sequence.js) ⭐ 318 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-18 - Sequence is modular web3 stack and smart wallet for Ethereum chains.
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 297 | 🐛 63 | 🌐 TypeScript | 📅 2026-09-22 - AlgoSDK is the official JavaScript library for communicating with the Algorand network.
* [@web3icons/react](https://github.com/0xa3k5/web3icons) ⭐ 281 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-15 - Web3 icons as React components. Includes tokens, coins, networks, wallets.
* [seaport-js](https://github.com/ProjectOpenSea/seaport-js) ⭐ 270 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - JavaScript library to interface with the Seaport marketplace.
* [dapparatus](https://github.com/austintgriffith/dapparatus) ⭐ 191 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-08 - Reusable dApp components in React.
* [ensjs](https://github.com/ensdomains/ensjs) ⭐ 158 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-22 - Javascript bindings for the Ethereum Name Service.
...
* [bee-js](https://github.com/ethersphere/bee-js) ⭐ 67 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-21 - Javascript client library for connecting to Bee decentralised storage.
...
* [@paritytech/bcts](https://github.com/paritytech/bcts) ⭐ 22 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - TypeSript library implementing common specifications for decentralized applications.
...
* [Formo SDK](https://github.com/getformo/sdk) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - Analytics and attribution SDK for onchain apps.
...
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,251 | 🐛 359 | 🌐 Solidity | 📅 2026-09-22 - The standard for secure blockchain applications.
* [Solady](https://github.com/Vectorized/solady) ⭐ 3,374 | 🐛 46 | 🌐 Solidity | 📅 2026-09-02 - Gas optimized Solidity Libraries.
...
* [CREATE2 Deployer](https://github.com/pcaversaccio/create2deployer) ⭐ 308 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16 - Helper smart contract to make easier and safer usage of the `CREATE2` EVM opcode.
...
* [avalanchego](https://github.com/ava-labs/avalanchego) ⭐ 2,359 | 🐛 341 | 🌐 Go | 📅 2026-09-22 - Go implementation of an Avalanche node.
* [tss-lib](https://github.com/bnb-chain/tss-lib) ⭐ 1,045 | 🐛 67 | 🌐 Go | 📅 2026-04-09 - This is an implementation of multi-party {t,n}-threshold ECDSA (Elliptic Curve Digital Signature Algorithm) based on Gennaro and Goldfeder CCS 2018 1 and EdDSA (Edwards-curve Digital Signature Algorithm)
* [eRPC](https://github.com/erpc/erpc) ⭐ 786 | 🐛 76 | 🌐 Go | 📅 2026-09-22 - Open-source EVM RPC proxy & cache service built to scale horizontally from small traffic to million RPS across many chains, optimized for read-heavy use-cases such as Indexers, Frontends, MEV bots, etc.
...
* [Smart Router](https://github.com/Magma-Devs/smart-router) ⭐ 16 | 🐛 15 | 🌐 Go | 📅 2026-09-22 - Reliability and security layer for blockchain RPC that orchestrates multiple upstreams behind a single endpoint, with automatic failover, data cross-validation, block-aware caching, and observability across EVM and non-EVM networks.
* [geth](https://geth.ethereum.org) - Official Go implementation of the Ethereum protocol.

### C/C++

* [Trust Wallet Core](https://github.com/trustwallet/wallet-core) ⭐ 3,570 | 🐛 185 | 🌐 C++ | 📅 2026-09-18 - Cross-platform, mobile-focused library implementing low-level cryptographic wallet functionality for a high number of blockchains.
* [libethc](https://github.com/mhw0/libethc) ⭐ 72 | 🐛 20 | 🌐 C | 📅 2026-02-18 - Open-source Ethereum library in ANSI C.

### Rust

* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,782 | 🐛 311 | 🌐 Rust | 📅 2026-09-22 - Modular, contributor-friendly and blazing-fast implementation of the Ethereum protocol, in Rust.
...
* [RustChain](https://rustchain.org) - Proof-of-Antiquity blockchain that rewards mining on vintage hardware (PowerPC G4, Pentium 4) with RTC tokens. Features 6-point hardware fingerprinting, Ergo chain anchoring, and an on-chain AI agent economy. ([source code](https://github.com/Scottcjn/rustchain) ⭐ 816 | 🐛 166 | 🌐 Python | 📅 2026-09-22)
* [browser-web3-signer](https://github.com/nikicat/browser-web3-signer) ⭐ 4 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-18 - Sign EVM and TRON transactions and messages with your own browser wallet (MetaMask, Rabby, TronLink) from the CLI or from Rust, TypeScript, and Go programs; the private key never leaves the browser.
...
* [web3.py](https://github.com/ethereum/web3.py) ⭐ 5,532 | 🐛 164 | 🌐 Python | 📅 2026-08-31 - Python interface for interacting with the Ethereum blockchain and ecosystem.
* [Vyper](https://github.com/vyperlang/vyper) ⭐ 5,181 | 🐛 625 | 🌐 Python | 📅 2026-09-21 - Contract-oriented, pythonic programming language that targets EVM.
* [py-evm](https://github.com/ethereum/py-evm) ⚠️ Archived - Ethereum protocol implementation in Python.
* [dexscraper](https://github.com/vincentkoc/dexscraper) ⭐ 116 | 🐛 1 | 🌐 Python | 📅 2026-04-30 - Python SDK and CLI for extracting real-time DexScreener market data over WebSocket and API.
...
* [evmone](https://github.com/ethereum/evmone) ⭐ 976 | 🐛 171 | 🌐 C++ | 📅 2026-09-22 - C++ implementation of the Ethereum Virtual Machine (EVM), faster.
...
* [ethereum-boilerplate](https://github.com/ethereum-boilerplate/ethereum-boilerplate) ⭐ 4,132 | 🐛 15 | 🌐 TypeScript | 📅 2024-06-19 - The ultimate NextJS Ethereum Dapp Boilerplate which gives you maximum flexibility and speed.
...
* [dapp-starter-template](https://github.com/jellydn/dapp-starter) ⭐ 327 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 - Opinionated Dapp Starter Template.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,366 | 🐛 477 | 🌐 Python | 📅 2026-09-09 - Solidity static analysis framework, a suite of vulnerability detectors, prints visual information about contract details etc.
* [solhint](https://github.com/protofire/solhint) ⭐ 1,126 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-22 - Solidity linter providing Security and Style Guide validations.
* [Slippy](https://github.com/slippy-lint/slippy) ⭐ 29 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-22 - Simple and powerful linter for Solidity.

### Database

* [Gun](https://github.com/amark/gun) ⭐ 19,134 | 🐛 321 | 🌐 JavaScript | 📅 2026-09-16 - Small, easy, and fast protocol for syncing data.
* [OrbitDB](https://github.com/orbitdb/orbit-db) ⭐ 8,810 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-14 - Serverless, distributed, peer-to-peer database.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,366 | 🐛 477 | 🌐 Python | 📅 2026-09-09 - A Solidity static analysis framework.
* [Mythril](https://github.com/ConsenSys/mythril) ⭐ 4,275 | 🐛 130 | 🌐 Python | 📅 2026-04-27 - Open-source EVM bytecode security analysis tool.
...
* [EVMole](https://github.com/cdump/evmole) ⭐ 465 | 🐛 2 | 🌐 Rust | 📅 2026-09-16 - Extracts function selectors from EVM bytecode, even for unverified contracts.
...
* [Inception Flap Scanner](https://github.com/Lukecele/inception-flap-scanner) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-18 - Real-time on-chain token launch screener, Flap.sh bonding curve telemetry tracker, and automated 4-tier contract security auditor on BNB Smart Chain.
* [SafeAgent](https://github.com/Bemosha/safeagent) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-26 - Browser extension that detects clipboard address substitution, unlimited-approval signatures, seed-phrase input forms, and typosquatted domains. Detection runs locally, no telemetry. MIT.
...
* [@up2itnow0822/agent-wallet-sdk](https://github.com/up2itnow0822/agent-wallet-sdk) ⭐ 13 | 🐛 34 | 🌐 TypeScript | 📅 2026-09-22 - TypeScript SDK for non-custodial AI agent wallets. Handles x402 payments, CCTP V2 cross-chain transfers, Uniswap V3 token swaps, and on-chain spend limits. MIT license.
* [x402-proxy](https://github.com/cascade-protocol/x402-proxy) ⭐ 11 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-14 - `curl` for x402 paid APIs. CLI and library that auto-pays HTTP 402 responses with USDC on Base and Solana, with MCP stdio proxy for AI agents.
...
* [Arch Tools](https://archtools.dev) - The first x402 API hub — 58+ AI tools for search, scraping, analysis, and generation with native Coinbase x402 crypto payments on 15+ chains. MCP compatible. [GitHub](https://github.com/Deesmo/Arch-AI-Tools) ⭐ 1 | 🐛 29 | 🌐 HTML | 📅 2026-09-21
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-09-06 - 54 services / 97 endpoints with 37 MCP tools: crypto prices, OHLCV, DeFi yields, technical indicators, DEX swap quotes, prediction markets, trending tokens, gas tracker, and on-chain analytics. 41 x402-paid endpoints (USDC on Base). Remote MCP server (TypeScript, cloud-hosted).
...
* [Cyrus Relay](https://github.com/ghassan-gaidi/cyrus-relay) ⭐ 0 | 🐛 0 | 🌐 HTML | 📅 2026-09-13 - OpenAI-compatible LLM gateway with per-request USDC pricing via the x402 protocol on Base, Arbitrum, and Polygon.

## AI & LLM & MCP

* [Kuberna Labs](https://github.com/kawacukennedy/kuberna-labs) ⭐ 51 | 🐛 48 | 🌐 TypeScript | 📅 2026-09-21 - Decentralized execution rails for AI agents. Deploy TEE-shielded agents to Ethereum, Solana, NEAR with ERC-7683 intents and zkTLS privacy.
* [web3-docs](https://github.com/dioptx/web3-docs) ⭐ 36 | 🐛 0 | 🌐 Python | 📅 2026-05-01 - Local MCP server with a searchable corpus of 1,767 EIPs, BIPs, ADRs, CIPs, and RFCs across 10 chains plus a canonical contract-address registry covering 19 protocols on major EVM chains. SQLite + FTS5, no API keys.
* [dRPC Agent Skills](https://github.com/drpcorg/drpc-agent-skills) ⭐ 23 | 🐛 3 | 🌐 TypeScript | 📅 2026-06-21 - Read-only on-chain data for AI agents via DRPC's node network. Covers all major EVM networks and Solana. Free API key at drpc.org.
* [Web3 Agent Kit](https://github.com/ulsreall/web3-agent-kit) ⭐ 20 | 🐛 13 | 🌐 Python | 📅 2026-09-22 - Open-source Python framework for building autonomous AI agents that interact with DeFi protocols. Multi-chain support (Ethereum, Base, Arbitrum, Optimism, Polygon), LLM-powered reasoning (OpenAI, Anthropic, Groq, DeepSeek), Uniswap V2 swaps, cross-chain bridges (Li.Fi, Socket), token sniper, and portfolio tracking.
* [Hive Intelligence](https://github.com/hive-intel/hive-crypto-mcp) ⭐ 19 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-17 🎖️ 📇 ☁️ 🏠 - Institutional-grade crypto market infrastructure for AI — live prices, DeFi, wallets, and token risk through a managed MCP, REST API, or CLI.
...
* [Pythia Oracle MCP](https://github.com/pythia-the-oracle/pythia-oracle-mcp) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-09-05 - On-chain calculated indicators (EMA, RSI, Bollinger, Volatility) for 22 tokens via Chainlink. MCP server + LangChain integration for AI agents to access DeFi data.
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-09-06 📇 ☁️ - Crypto/financial market data APIs for AI agents. 54 services, 97 endpoints, 37 MCP tools, 41 x402-paid endpoints (USDC on Base). Prices, OHLCV, DeFi yields, DEX quotes, on-chain analytics, social sentiment, gas tracker. Remote MCP server (TypeScript, cloud-hosted).
* [Assay Protocol](https://github.com/Grandionn/assay-protocol) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-25 - Economic trust enforcement for AI agents on Base. USDC staking, outcome-verified escrow, algorithmic reputation scoring (0-1000), and semantic discovery for ERC-8004 agents. 2000+ agents indexed.
...
* [Solidity](https://github.com/ethereum/solidity) ⭐ 25,738 | 🐛 828 | 🌐 C++ | 📅 2026-09-22 - Solidity is statically typed, contract-oriented, high-level language for implementing smart contracts on the Ethereum platform.
* [fabric](https://github.com/hyperledger/fabric) ⭐ 16,726 | 🐛 205 | 🌐 Go | 📅 2026-09-22 - Hyperledger Fabric is enterprise-grade permissioned distributed ledger framework for developing solutions and applications.
...
* [MetaMask](https://github.com/MetaMask/metamask-extension) ⭐ 13,218 | 🐛 2,811 | 🌐 TypeScript | 📅 2026-09-22 - Browser extension of MetaMask crypto wallet.
* [Chainlink](https://github.com/smartcontractkit/chainlink) ⭐ 8,247 | 🐛 185 | 🌐 Go | 📅 2026-09-22 - Chainlink enhances the possibilities of smart contracts by allowing them to access real-world data.
* [Blockscout](https://github.com/blockscout/blockscout) ⭐ 4,707 | 🐛 167 | 🌐 Elixir | 📅 2026-09-22 - Blockchain explorer for Ethereum based network and a tool for inspecting and analyzing EVM based blockchains.
* [Rainbow](https://github.com/rainbow-me/rainbow) ⭐ 4,393 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-22 - Open source Ethereum wallet.
* [Neo](https://github.com/neo-project/neo) ⭐ 3,536 | 🐛 262 | 🌐 C# | 📅 2026-09-21 - Neo is blockchain platform that is open-source and community-driven.
* [Remix](https://github.com/ethereum/remix-project) ⭐ 3,056 | 🐛 913 | 🌐 TypeScript | 📅 2026-09-22 - Browser-based compiler and IDE that enables users to build Ethereum contracts with Solidity language and to debug transactions.
* [Rabby](https://github.com/RabbyHub/Rabby) ⭐ 1,896 | 🐛 142 | 🌐 TypeScript | 📅 2026-09-22 - Browser extension crypto wallet for the DeFi ecosystem that works multi-chain.
* [web3swift](https://github.com/web3swift-team/web3swift) ⭐ 889 | 🐛 77 | 🌐 JavaScript | 📅 2025-09-24 - web3swift is iOS toolbelt for interaction with the Ethereum network.
* [Ethora](https://github.com/dappros/ethora) ⭐ 548 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-22 - Ethora is a low code web3 'super app' engine featuring social sign on, chat, bots, gamification, digital wallet, documents sharing etc. It is easy to customize and build your own app based on Ethora engine.
* [Ambire Wallet](https://github.com/AmbireTech/wallet) ⭐ 237 | 🐛 5 | 🌐 JavaScript | 📅 2026-03-16 - Open source Web3 wallet that makes self-custody easy and secure via account abstraction.
* [Vocdoni](https://github.com/vocdoni/vocdoni-node) ⭐ 92 | 🐛 90 | 🌐 Go | 📅 2026-09-22 - Decentralized voting protocol with an AGPL-3.0 Go implementation for verifiable organizational elections.
...
* [Vultisig](https://github.com/vultisig/vultisig-windows) ⭐ 20 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-22 - Seedless self-custodial multi-chain wallet secured by MPC threshold signatures; this repo builds the Vultisig desktop app and the Chrome extension.
* [Mybucks.online](https://github.com/mybucks-online/app) ⭐ 19 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - Open-source, browser-based and self-custodial wallet that generates a private key from credentials using one-way hash function.
* [Arb-Inc All-in-Dex](https://github.com/Lukecele/Arb-Inc-All-in-Dex) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20 - Production-ready decentralized exchange aggregator, cross-chain bridge, and real-yield engine on BNB Smart Chain.
...
* [Chainslake](https://github.com/chainslake/chainslake-onprem) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-09-06 - A self-hosted blockchain data warehouse built on HDFS, Spark, Delta Lake, Trino, and Airflow — multi-chain EVM data pipelines with an AI agent team that automates pipeline development and management
* [@P2Flux/contracts](https://github.com/P2Flux/contracts) ⭐ 0 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-18 - Non-custodial USDC payment infrastructure for one-time and recurring payments, with direct wallet-to-wallet settlement, developer SDKs, and sponsored network fees payable in USDC.
...
* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,531 | 🐛 1 | 📅 2026-09-22
...
Contributions are welcomed! Please read the [contribution guidelines](https://github.com/ahmet/awesome-web3/blob/main/CONTRIBUTING.md) ⭐ 893 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-21 first.
