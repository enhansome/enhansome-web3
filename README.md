...
* [Solidity](https://github.com/bkrem/awesome-solidity) ⭐ 7,039 | 🐛 22 | 📅 2026-08-11 - Curated list of awesome Solidity resources, libraries, tools and more.
* [Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,622 | 🐛 53 | 🌐 Go | 📅 2024-03-22 - Curated list of resources for the development and applications of blockchain.
* [Web3 Security](https://github.com/Anugrahsr/Awesome-web3-Security) ⭐ 1,619 | 🐛 13 | 📅 2026-03-01 - Curated list of web3 security materials and resources for pentesters and bug hunters.
* [Zero Knowledge](https://github.com/ventali/awesome-zk) ⭐ 1,583 | 🐛 8 | 📅 2024-10-15 - Curated list of awesome ZK resources, libraries, tools and more.
* [StarkNet](https://github.com/gakonst/awesome-starknet) ⭐ 1,550 | 🐛 20 | 📅 2025-01-06 - Curated list of awesome StarkNet resources, libraries, tools and more.
* [ethereum-security](https://github.com/crytic/awesome-ethereum-security) ⭐ 1,485 | 🐛 37 | 📅 2024-08-20 - Curated list of Ethereum security references, guidance, tools, and more.
...
* [Account Abstraction](https://github.com/4337Mafia/awesome-account-abstraction) ⭐ 1,015 | 🐛 760 | 📅 2026-06-09 - Collection of account abstraction resources.
* [NFT](https://github.com/gianni-dalerta/awesome-nft) ⭐ 974 | 🐛 1 | 📅 2022-08-18 - Curated list of awesome Non Fungible Token (NFT, ERC721) frameworks, libraries and software.
* [RPC Nodes](https://github.com/arddluma/awesome-list-rpc-nodes-providers) ⭐ 915 | 🐛 1,250 | 📅 2025-08-28 - Curated list of awesome Node providers and public RPC endpoints.
* [Ethereum](https://github.com/bekatom/awesome-ethereum) ⭐ 912 | 🐛 35 | 📅 2025-04-09 - Awesome Ethereum & Dapps Resources.
...
* [Huff](https://github.com/devtooligan/awesome-huff) ⭐ 316 | 🐛 1 | 📅 2024-01-11 - Curated list of resources for Huff language.
...
* [x402](https://github.com/xpaysh/awesome-x402) ⭐ 277 | 🐛 258 | 📅 2026-07-28 - Internet-native payment protocol using HTTP 402 status code for blockchain payments.
* [Lens Protocol](https://github.com/0xJuancito/awesome-lens-protocol) ⭐ 233 | 🐛 0 | 📅 2026-02-04 - Curated list of awesome Lens Protocol projects, resources, libraries, tools and more.
* [Algorand](https://github.com/aorumbayev/awesome-algorand) ⭐ 218 | 🐛 5 | 📅 2026-06-30 - Curated list of awesome resources related to the Algorand Blockchain.
* [Reth](https://github.com/jmcph4/awesome-reth) ⭐ 120 | 🐛 1 | 📅 2025-04-02 - Curated list of awesome Reth resources.
* [Vyper](https://github.com/spadebuilders/awesome-vyper) ⭐ 98 | 🐛 0 | 📅 2023-01-11 - Curated resources for Vyper, the Pythonic smart contract language for the EVM.
* [XMTP](https://github.com/xmtp/awesome-xmtp) ⚠️ Archived - Curated list of awesome resources and projects built using XMTP.
* [Thirdweb](https://github.com/warengonzaga/awesome-thirdweb) ⭐ 65 | 🐛 1 | 📅 2024-09-24 - Curated list of awesome thirdweb resources, libraries, examples, showcase, and open source projects.
...
* [SwapTitan MCP](https://github.com/polsolbridge/swaptitan-mcp) ⭐ 1 | 🐛 1 | 🌐 Dockerfile | 📅 2026-06-20 - No-KYC crypto swap MCP server for AI agents. 10 tools: swap, prices, portfolio, rug check. 1288+ assets. x402 micropayments.
* [AI × Crypto Tools](https://github.com/FlipZ3ro/awesome-ai-crypto-tools#readme) ⭐ 1 | 🐛 1 | 📅 2026-06-18 - Curated list of AI-powered tools for crypto trading, analysis, security, and development.
* [Web3 Jobs](https://github.com/ceosvex/awesome-web3-jobs) ⭐ 0 | 🐛 2 | 📅 2026-04-17 - Curated list of job boards, companies, salary data, and career resources for finding web3 and crypto jobs.
* [The Graph](https://github.com/MichaelMacaulay/Awesome-The-Graph) - Curated list of awesome resources for The Graph.

## Reference

* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,908 | 🐛 48 | 🌐 Wikitext | 📅 2026-08-13 - Bitcoin Improvement Proposals.
...
* [evm.codes](https://www.evm.codes) - An interactive reference to Ethereum Virtual Machine Opcodes ([source code](https://github.com/comitylabs/evm.codes) ⭐ 826 | 🐛 55 | 🌐 TypeScript | 📅 2026-07-13).
...
* [DeFi Developer](https://github.com/OffcierCia/DeFi-Developer-Road-Map) ⭐ 10,801 | 🐛 4 | 🌐 JavaScript | 📅 2026-07-26 - Curated Web3.0 Developer handbook which includes a list of the best tools for DApps, development resources and lifehacks.
...
* [Yul By Example](https://github.com/Perelyn-sama/yul_by_example) ⭐ 255 | 🐛 0 | 🌐 HTML | 📅 2024-08-27 - Basic examples on Yul.

### Development Environment

* [Embark](https://github.com/embarklabs/embark) ⭐ 3,772 | 🐛 134 | 🌐 JavaScript | 📅 2024-07-30 - The all-in-one developer platform for building and deploying decentralized applications.
* [Brownie](https://github.com/eth-brownie/brownie) ⭐ 2,723 | 🐛 397 | 🌐 C | 📅 2026-08-05 - Python-based development and testing framework for smart contracts targeting the Ethereum Virtual Machine.
* [Ethereum Code Viewer](https://github.com/dethcrypto/ethereum-code-viewer) ⭐ 1,372 | 🐛 23 | 🌐 TypeScript | 📅 2025-09-30 - View source of deployed Ethereum smart contracts in VS Code.
* [Solana Playground](https://github.com/solana-playground/solana-playground) ⭐ 955 | 🐛 120 | 🌐 Rust | 📅 2026-08-12 - Online IDE to quickly develop and deploy Solana programs that runs on web browser.
...
* [Tatum SDK](https://github.com/tatumio/tatum-js) ⭐ 399 | 🐛 19 | 🌐 TypeScript | 📅 2026-06-08 - Tatum SDK is a powerful, feature-rich TypeScript/JavaScript library that streamlines the development of blockchain applications.
...
* [Clanker Wallet](https://github.com/almogdepaz/clanker-wallet) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-04-30 - Human-approved blockchain transactions for AI agents. Agent proposes a tx, human reviews and signs from a web app. E2E encrypted, CLI + TypeScript + Python SDKs.
* [AxonFi SDK](https://github.com/axonfi/sdk) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-16 - Non-custodial treasury and payment SDK for AI agents. Agents sign EIP-712 intents from secure vaults without holding funds or paying gas. TypeScript, Python, and LangChain integrations. Multi-chain (Base, Arbitrum).
...
* [WalletLink](https://github.com/walletlink/walletlink) ⭐ 1,759 | 🐛 85 | 🌐 TypeScript | 📅 2026-04-30 - Open protocol that lets users connect their mobile wallets to your DApp.
...
* [Ophis](https://ophis.fi) - Intent-based DEX aggregator (a CoW Protocol fork) for gasless, MEV-protected swaps across 11 chains, with an MCP server and SDK for AI agents. ([GitHub](https://github.com/ophis-fi/ophis) ⭐ 3 | 🐛 21 | 🌐 Rust | 📅 2026-08-13 · [Docs](https://docs.ophis.fi))
* [MolTrust](https://moltrust.ch) - Trust infrastructure for AI agents. W3C DID identity verification, reputation scoring, Ed25519-signed Verifiable Credentials, and Base blockchain anchoring. ([SDK](https://github.com/MoltyCel/moltrust-sdk) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-04-25 · [PyPI](https://pypi.org/project/moltrust/) · [API Docs](https://api.moltrust.ch/docs))
...
* [ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,706 | 🐛 656 | 🌐 TypeScript | 📅 2026-06-18 - Complete Ethereum wallet implementation and utilities in JavaScript (and TypeScript).
* [js-ipfs](https://github.com/ipfs/js-ipfs) ⚠️ Archived - IPFS implementation in JavaScript.
* [wagmi](https://github.com/wevm/wagmi) ⭐ 6,740 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-10 - React hooks library for Ethereum.
* [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,997 | 🐛 51 | 🌐 JavaScript | 📅 2026-02-17 - Bitcoin library for node.js and browsers.
...
* [solana-web3.js](https://github.com/solana-labs/solana-web3.js) ⭐ 2,749 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-28 - Solana Javascript API built on the Solana JSON RPC API.
* [starknet.js](https://github.com/0xs34n/starknet.js) ⭐ 1,257 | 🐛 41 | 🌐 TypeScript | 📅 2026-08-07 - JavaScript library to interact with Starknet.
* [OnchainKit](https://github.com/coinbase/onchainkit) ⭐ 1,044 | 🐛 169 | 🌐 TypeScript | 📅 2026-01-31 - Collection of tools to build world-class onchain apps with CSS, React, and Typescript.
* [Hashgraph Online Standards SDK](https://github.com/hashgraph-online/standards-sdk) ⭐ 845 | 🐛 13 | 🌐 TypeScript | 📅 2026-05-08 - TypeScript SDK for Hedera Consensus Service standards (HCS-1 through HCS-11), enabling decentralized file storage, NFT metadata, and recursive content on Hedera.
* [Tatum JavaScript SDK](https://github.com/tatumio/tatum-js) ⭐ 399 | 🐛 19 | 🌐 TypeScript | 📅 2026-06-08 - Tatum SDK is a powerful, feature-rich TypeScript/JavaScript library that streamlines the development of blockchain applications.
* [avalanchejs](https://github.com/ava-labs/avalanchejs) ⭐ 357 | 🐛 27 | 🌐 TypeScript | 📅 2026-08-11 - JavaScript Library for interfacing with the Avalanche Platform.
* [sequence.js](https://github.com/0xsequence/sequence.js) ⭐ 317 | 🐛 31 | 🌐 TypeScript | 📅 2026-07-27 - Sequence is modular web3 stack and smart wallet for Ethereum chains.
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 298 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-12 - AlgoSDK is the official JavaScript library for communicating with the Algorand network.
* [seaport-js](https://github.com/ProjectOpenSea/seaport-js) ⭐ 269 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12 - JavaScript library to interface with the Seaport marketplace.
* [@web3icons/react](https://github.com/0xa3k5/web3icons) ⭐ 259 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-03 - Web3 icons as React components. Includes tokens, coins, networks, wallets.
* [dapparatus](https://github.com/austintgriffith/dapparatus) ⭐ 192 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-08 - Reusable dApp components in React.
* [ensjs](https://github.com/ensdomains/ensjs) ⭐ 156 | 🐛 22 | 🌐 TypeScript | 📅 2026-07-31 - Javascript bindings for the Ethereum Name Service.
* [ipfs-mini](https://github.com/silentcicero/ipfs-mini) ⭐ 152 | 🐛 12 | 🌐 JavaScript | 📅 2022-06-08 - Super tiny module for querying an IPFS node, that works in the browser and in Node.
* [Lens.js](https://github.com/suhailkakar/lens.js/) ⭐ 124 | 🐛 11 | 🌐 TypeScript | 📅 2023-01-09 - Lens.js is JavaScript SDK or API wrapper for the Lens API.
...
* [bee-js](https://github.com/ethersphere/bee-js) ⭐ 67 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-11 - Javascript client library for connecting to Bee decentralised storage.
...
* [@paritytech/bcts](https://github.com/paritytech/bcts) ⭐ 22 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-10 - TypeSript library implementing common specifications for decentralized applications.
* [db3.js](https://github.com/dbpunk-labs/db3.js) ⚠️ Archived - DB3.js is SDK of DB3 network, a community-driven layer2 decentralized database network.
* [attestate/crawler](https://github.com/attestate/crawler) ⭐ 6 | 🐛 3 | 🌐 JavaScript | 📅 2025-11-03 - JavaScript library for retrieving on-chain storage and generating data derivatives.
* [Formo SDK](https://github.com/getformo/sdk) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-07 - Analytics and attribution SDK for onchain apps.
...
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,213 | 🐛 364 | 🌐 Solidity | 📅 2026-08-12 - The standard for secure blockchain applications.
* [Solady](https://github.com/Vectorized/solady) ⭐ 3,350 | 🐛 44 | 🌐 Solidity | 📅 2026-08-02 - Gas optimized Solidity Libraries.
...
* [CREATE2 Deployer](https://github.com/pcaversaccio/create2deployer) ⭐ 307 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-10 - Helper smart contract to make easier and safer usage of the `CREATE2` EVM opcode.
* [DeFiMath](https://github.com/MerkleBlue/defimath) ⭐ 17 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-07 - Gas-optimized Solidity library for DeFi math: Black-Scholes option pricing, Greeks, interest rates, and statistics.

### Go

* [avalanchego](https://github.com/ava-labs/avalanchego) ⭐ 2,356 | 🐛 327 | 🌐 Go | 📅 2026-08-12 - Go implementation of an Avalanche node.
* [tss-lib](https://github.com/bnb-chain/tss-lib) ⭐ 1,032 | 🐛 67 | 🌐 Go | 📅 2026-04-09 - This is an implementation of multi-party {t,n}-threshold ECDSA (Elliptic Curve Digital Signature Algorithm) based on Gennaro and Goldfeder CCS 2018 1 and EdDSA (Edwards-curve Digital Signature Algorithm)
* [eRPC](https://github.com/erpc/erpc) ⭐ 754 | 🐛 61 | 🌐 Go | 📅 2026-08-12 - Open-source EVM RPC proxy & cache service built to scale horizontally from small traffic to million RPS across many chains, optimized for read-heavy use-cases such as Indexers, Frontends, MEV bots, etc.
...
* [avalanche-network-runner](https://github.com/ava-labs/avalanche-network-runner) ⭐ 97 | 🐛 60 | 🌐 Go | 📅 2026-04-03 - Tool to run and interact with an Avalanche network locally.
...
* [Smart Router](https://github.com/Magma-Devs/smart-router) ⭐ 16 | 🐛 16 | 🌐 Go | 📅 2026-08-13 - Reliability and security layer for blockchain RPC that orchestrates multiple upstreams behind a single endpoint, with automatic failover, data cross-validation, block-aware caching, and observability across EVM and non-EVM networks.
* [geth](https://geth.ethereum.org) - Official Go implementation of the Ethereum protocol.

### C/C++

* [Trust Wallet Core](https://github.com/trustwallet/wallet-core) ⭐ 3,553 | 🐛 167 | 🌐 C++ | 📅 2026-08-07 - Cross-platform, mobile-focused library implementing low-level cryptographic wallet functionality for a high number of blockchains.
* [libethc](https://github.com/mhw0/libethc) ⭐ 72 | 🐛 20 | 🌐 C | 📅 2026-02-18 - Open-source Ethereum library in ANSI C.

### Rust

* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,740 | 🐛 218 | 🌐 Rust | 📅 2026-08-12 - Modular, contributor-friendly and blazing-fast implementation of the Ethereum protocol, in Rust.
...
* [RustChain](https://rustchain.org) - Proof-of-Antiquity blockchain that rewards mining on vintage hardware (PowerPC G4, Pentium 4) with RTC tokens. Features 6-point hardware fingerprinting, Ergo chain anchoring, and an on-chain AI agent economy. ([source code](https://github.com/Scottcjn/rustchain) ⭐ 576 | 🐛 170 | 🌐 Python | 📅 2026-08-12)
* [browser-web3-signer](https://github.com/nikicat/browser-web3-signer) ⭐ 1 | 🐛 2 | 🌐 Rust | 📅 2026-08-07 - Sign EVM and TRON transactions and messages with your own browser wallet (MetaMask, Rabby, TronLink) from the CLI or from Rust, TypeScript, and Go programs; the private key never leaves the browser.

### Shell

* [avash](https://github.com/ava-labs/avash) ⚠️ Archived - Avalanche shell client provides temporary stateful shell execution environment used to deploy networks locally, manage their processes, and run network tests.

### Python

* [web3.py](https://github.com/ethereum/web3.py) ⭐ 5,520 | 🐛 169 | 🌐 Python | 📅 2026-05-01 - Python interface for interacting with the Ethereum blockchain and ecosystem.
* [Vyper](https://github.com/vyperlang/vyper) ⭐ 5,178 | 🐛 694 | 🌐 Python | 📅 2026-08-12 - Contract-oriented, pythonic programming language that targets EVM.
* [py-evm](https://github.com/ethereum/py-evm) ⚠️ Archived - Ethereum protocol implementation in Python.
* [dexscraper](https://github.com/vincentkoc/dexscraper) ⭐ 112 | 🐛 0 | 🌐 Python | 📅 2026-04-30 - Python SDK and CLI for extracting real-time DexScreener market data over WebSocket and API.
...
* [Polkadart](https://github.com/leonardocustodio/polkadart) ⭐ 51 | 🐛 19 | 🌐 Dart | 📅 2026-06-26 - Dart library to interact with any Polkadot based blockchain.

### VMs

* [evmone](https://github.com/ethereum/evmone) ⭐ 975 | 🐛 147 | 🌐 C++ | 📅 2026-08-12 - C++ implementation of the Ethereum Virtual Machine (EVM), faster.
...
* [ethereum-boilerplate](https://github.com/ethereum-boilerplate/ethereum-boilerplate) ⭐ 4,138 | 🐛 15 | 🌐 TypeScript | 📅 2024-06-19 - The ultimate NextJS Ethereum Dapp Boilerplate which gives you maximum flexibility and speed.
...
* [create-web3-dapp](https://github.com/alchemyplatform/create-web3-dapp) ⭐ 913 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-10 - The complete toolbox to create web3 applications.
* [nexth](https://github.com/wslyvh/nexth) ⭐ 747 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-21 - Next.js + Ethereum starter kit to quickly ship Web3 Apps.
* [Turbo ETH](https://github.com/turbo-eth/template-web3-app) ⭐ 385 | 🐛 27 | 🌐 TypeScript | 📅 2024-05-03 - Web3 App Template in Next.js 13, Tailwind, RainbowKit and Optimized Developer UX.
* [dapp-starter-template](https://github.com/jellydn/dapp-starter) ⭐ 327 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-12 - Opinionated Dapp Starter Template.
...
* [solidity-coverage](https://github.com/sc-forks/solidity-coverage) ⭐ 1,003 | 🐛 42 | 🌐 JavaScript | 📅 2025-12-11 - Code coverage for Solidity smart-contracts.
* [Waffle](https://github.com/EthWorks/Waffle) ⭐ 962 | 🐛 81 | 🌐 TypeScript | 📅 2023-11-22 - Library for writing and testing smart contracts.
...
* [prb-test](https://github.com/PaulRBerg/prb-test) ⭐ 184 | 🐛 3 | 🌐 Solidity | 📅 2024-12-26 - Modern collection of testing assertions and logging utilities for Solidity.
* [mock-contract](https://github.com/gnosis/mock-contract) ⭐ 93 | 🐛 6 | 🌐 JavaScript | 📅 2022-02-21 - Simple Solidity contract to mock dependent contracts in truffle tests.
* [Robot Framework Solidity Testing Toolkit](https://github.com/jg8481/Robot-Framework-Solidity-Testing-Toolkit) ⭐ 13 | 🐛 14 | 🌐 HTML | 📅 2026-08-10 - This combines popular smart contract testing and deployment libraries with Robot Framework (a generic RPA ecosystem).

### Code Quality

* [Slither](https://github.com/crytic/slither) ⭐ 6,343 | 🐛 468 | 🌐 Python | 📅 2026-08-12 - Solidity static analysis framework, a suite of vulnerability detectors, prints visual information about contract details etc.
* [solhint](https://github.com/protofire/solhint) ⭐ 1,126 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-10 - Solidity linter providing Security and Style Guide validations.
* [Slippy](https://github.com/slippy-lint/slippy) ⭐ 28 | 🐛 6 | 🌐 TypeScript | 📅 2025-12-22 - Simple and powerful linter for Solidity.

### Database

* [Gun](https://github.com/amark/gun) ⭐ 19,109 | 🐛 314 | 🌐 JavaScript | 📅 2026-08-01 - Small, easy, and fast protocol for syncing data.
* [OrbitDB](https://github.com/orbitdb/orbit-db) ⭐ 8,795 | 🐛 24 | 🌐 JavaScript | 📅 2026-05-14 - Serverless, distributed, peer-to-peer database.
...
* [WeaveDB](https://github.com/weavedb/weavedb) ⭐ 208 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-26 - WeaveDB is NoSQL Database as Smart Contract Bringing web2-like smooth UX, complexity, and scalability to web3 dApps.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,343 | 🐛 468 | 🌐 Python | 📅 2026-08-12 - A Solidity static analysis framework.
* [Mythril](https://github.com/ConsenSys/mythril) ⭐ 4,259 | 🐛 129 | 🌐 Python | 📅 2026-04-27 - Open-source EVM bytecode security analysis tool.
* [Manticore](https://github.com/trailofbits/manticore) ⚠️ Archived - Symbolic execution tool on smart contracts and binaries.
* [Solidity security blog](https://github.com/sigp/solidity-security-blog) ⭐ 1,523 | 🐛 4 | 📅 2022-09-23 - Comprehensive list of known attack vectors and common anti-patterns.
...
* [EVMole](https://github.com/cdump/evmole) ⭐ 457 | 🐛 2 | 🌐 Rust | 📅 2026-08-02 - Extracts function selectors from EVM bytecode, even for unverified contracts.
...
* [TRONSEC](https://tronsec.io/app/) - Client-side TRON security toolkit: wallet analysis, AML heuristics, contract scanning, transaction decoding, and phishing URL checks. No wallet connection required. [Source](https://github.com/jamejohns/tronsec) ⭐ 44 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-18.
* [Adelaide](https://github.com/sec-bit/adelaide) ⭐ 18 | 🐛 0 | 🌐 C++ | 📅 2019-01-31 - The SECBIT static analysis extension to Solidity compiler.
...
* [x402-proxy](https://github.com/cascade-protocol/x402-proxy) ⭐ 10 | 🐛 7 | 🌐 TypeScript | 📅 2026-06-11 - `curl` for x402 paid APIs. CLI and library that auto-pays HTTP 402 responses with USDC on Base and Solana, with MCP stdio proxy for AI agents.
...
* [@up2itnow0822/agent-wallet-sdk](https://github.com/up2itnow0822/agent-wallet-sdk) ⭐ 8 | 🐛 19 | 🌐 TypeScript | 📅 2026-08-11 - TypeScript SDK for non-custodial AI agent wallets. Handles x402 payments, CCTP V2 cross-chain transfers, Uniswap V3 token swaps, and on-chain spend limits. MIT license.
...
* [Arch Tools](https://archtools.dev) - The first x402 API hub — 58+ AI tools for search, scraping, analysis, and generation with native Coinbase x402 crypto payments on 15+ chains. MCP compatible. [GitHub](https://github.com/Deesmo/Arch-AI-Tools) ⭐ 1 | 🐛 14 | 🌐 HTML | 📅 2026-08-12
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 3 | 🌐 Python | 📅 2026-08-12 - 54 services / 97 endpoints with 37 MCP tools: crypto prices, OHLCV, DeFi yields, technical indicators, DEX swap quotes, prediction markets, trending tokens, gas tracker, and on-chain analytics. 41 x402-paid endpoints ($0.01-$0.05/call, USDC on Base). Remote MCP server, cloud-hosted.
* [SpraayBatch](https://github.com/plagtech/SpraayBatch) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-08 - Batch USDC payments on Base for AI agents — pay up to 200 recipients in one atomic transaction. Gasless via CDP Paymaster, non-custodial auto-wallets, per-agent budget caps. OpenClaw plugin with ClawHub security audit pass. ([ClawHub](https://clawhub.ai/plagtech/plugins/spraay-batch))

## AI & LLM & MCP

* [Kuberna Labs](https://github.com/kawacukennedy/kuberna-labs) ⭐ 49 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-11 - Decentralized execution rails for AI agents. Deploy TEE-shielded agents to Ethereum, Solana, NEAR with ERC-7683 intents and zkTLS privacy.
* [dRPC Agent Skills](https://github.com/drpcorg/drpc-agent-skills) ⭐ 22 | 🐛 1 | 🌐 TypeScript | 📅 2026-06-21 - Read-only on-chain data for AI agents via DRPC's node network. Covers all major EVM networks and Solana. Free API key at drpc.org.
* [web3-docs](https://github.com/dioptx/web3-docs) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2026-05-01 - Local MCP server with a searchable corpus of 1,767 EIPs, BIPs, ADRs, CIPs, and RFCs across 10 chains plus a canonical contract-address registry covering 19 protocols on major EVM chains. SQLite + FTS5, no API keys.
* [Hive Intelligence](https://github.com/hive-intel/hive-crypto-mcp) ⭐ 18 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-02 🎖️ 📇 ☁️ 🏠 - Institutional-grade crypto market infrastructure for AI — live prices, DeFi, wallets, and token risk through a managed MCP, REST API, or CLI.
* [Web3 Agent Kit](https://github.com/ulsreall/web3-agent-kit) ⭐ 18 | 🐛 9 | 🌐 Python | 📅 2026-08-10 - Open-source Python framework for building autonomous AI agents that interact with DeFi protocols. Multi-chain support (Ethereum, Base, Arbitrum, Optimism, Polygon), LLM-powered reasoning (OpenAI, Anthropic, Groq, DeepSeek), Uniswap V2 swaps, cross-chain bridges (Li.Fi, Socket), token sniper, and portfolio tracking.
* [AgentsCoin](https://github.com/axiosdevs/agentscoin-mcp) ⭐ 4 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-29 - Give your AI agent its own money on a live EVM chain (chainId 24368): wallet, faucet, send, and create/trade tokens via MCP.
* [Pythia Oracle MCP](https://github.com/pythia-the-oracle/pythia-oracle-mcp) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-05-26 - On-chain calculated indicators (EMA, RSI, Bollinger, Volatility) for 22 tokens via Chainlink. MCP server + LangChain integration for AI agents to access DeFi data.
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 3 | 🌐 Python | 📅 2026-08-12 📇 ☁️ - Crypto/financial market data APIs for AI agents. 54 services, 97 endpoints, 37 MCP tools, 41 x402-paid endpoints (USDC on Base). Prices, OHLCV, DeFi yields, DEX quotes, on-chain analytics, social sentiment, gas tracker. Remote MCP server (TypeScript, cloud-hosted).
* [Assay Protocol](https://github.com/Grandionn/assay-protocol) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-25 - Economic trust enforcement for AI agents on Base. USDC staking, outcome-verified escrow, algorithmic reputation scoring (0-1000), and semantic discovery for ERC-8004 agents. 2000+ agents indexed. ([npm](https://www.npmjs.com/package/@assaylabs/trust-check))
* [BaseLens](https://github.com/YoungAlgy/baselens) ⭐ 0 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-07 - Pay-per-call AI agent that reads any Base address and returns a structured risk/activity report over x402 (a few cents in USDC). Built with Coinbase's CDP SDK and Anthropic's API.
...
* [Solidity](https://github.com/ethereum/solidity) ⭐ 25,703 | 🐛 786 | 🌐 C++ | 📅 2026-08-12 - Solidity is statically typed, contract-oriented, high-level language for implementing smart contracts on the Ethereum platform.
* [fabric](https://github.com/hyperledger/fabric) ⭐ 16,698 | 🐛 205 | 🌐 Go | 📅 2026-08-05 - Hyperledger Fabric is enterprise-grade permissioned distributed ledger framework for developing solutions and applications.
...
* [MetaMask](https://github.com/MetaMask/metamask-extension) ⭐ 13,199 | 🐛 2,875 | 🌐 TypeScript | 📅 2026-08-13 - Browser extension of MetaMask crypto wallet.
* [Chainlink](https://github.com/smartcontractkit/chainlink) ⭐ 8,236 | 🐛 185 | 🌐 Go | 📅 2026-08-13 - Chainlink enhances the possibilities of smart contracts by allowing them to access real-world data.
* [Blockscout](https://github.com/blockscout/blockscout) ⭐ 4,634 | 🐛 167 | 🌐 Elixir | 📅 2026-08-12 - Blockchain explorer for Ethereum based network and a tool for inspecting and analyzing EVM based blockchains.
* [Rainbow](https://github.com/rainbow-me/rainbow) ⭐ 4,380 | 🐛 23 | 🌐 TypeScript | 📅 2026-08-13 - Open source Ethereum wallet.
* [Neo](https://github.com/neo-project/neo) ⭐ 3,535 | 🐛 258 | 🌐 C# | 📅 2026-08-09 - Neo is blockchain platform that is open-source and community-driven.
* [Remix](https://github.com/ethereum/remix-project) ⭐ 3,038 | 🐛 909 | 🌐 TypeScript | 📅 2026-08-13 - Browser-based compiler and IDE that enables users to build Ethereum contracts with Solidity language and to debug transactions.
* [Rabby](https://github.com/RabbyHub/Rabby) ⭐ 1,880 | 🐛 139 | 🌐 TypeScript | 📅 2026-08-12 - Browser extension crypto wallet for the DeFi ecosystem that works multi-chain.
* [web3swift](https://github.com/web3swift-team/web3swift) ⭐ 890 | 🐛 74 | 🌐 JavaScript | 📅 2025-09-24 - web3swift is iOS toolbelt for interaction with the Ethereum network.
* [Ethora](https://github.com/dappros/ethora) ⭐ 542 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-11 - Ethora is a low code web3 'super app' engine featuring social sign on, chat, bots, gamification, digital wallet, documents sharing etc. It is easy to customize and build your own app based on Ethora engine.
* [Ambire Wallet](https://github.com/AmbireTech/wallet) ⭐ 232 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-16 - Open source Web3 wallet that makes self-custody easy and secure via account abstraction.
...
* [Mybucks.online](https://github.com/mybucks-online/app) ⭐ 19 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-11 - Open-source, browser-based and self-custodial wallet that generates a private key from credentials using one-way hash function.
...
* [Vaultion](https://github.com/troysteele5-dotcom/vaultion-contracts) ⭐ 0 | 🐛 0 | 🌐 Solidity | 📅 2026-07-11 - Non-custodial crypto escrow for stablecoin deals. Funds lock in an open-source smart contract and release on agreement or by dispute ruling.
...
* [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 551 | 🐛 0 | 🌐 Go | 📅 2025-08-17 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC
* Building EVM from scratch. - [link](https://karmacoma.notion.site/Building-an-EVM-from-scratch-part-1-c28ebb4200c94f6fb75948a5feffc686) [source code](https://github.com/karmacoma-eth/yolo-evm/tree/evm-from-scratch-pt1) ⚠️ Archived
...
* [IPFS to Swarm](https://github.com/Solar-Punk-Ltd/ipfs-to-swarm) ⭐ 3 | 🐛 0 | 🌐 TypeScript | 📅 2025-08-04 - CLI tool for moving decentralized content from IPFS to Swarm storage.
...
* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,517 | 🐛 1 | 📅 2026-05-13
* [Token Economy Book](https://github.com/sherminvo/TokenEconomyBook/wiki) ⭐ 810 | 🐛 3 | 📅 2025-05-17
...
Contributions are welcomed! Please read the [contribution guidelines](https://github.com/ahmet/awesome-web3/blob/main/CONTRIBUTING.md) ⭐ 886 | 🐛 23 | 🌐 JavaScript | 📅 2026-08-10 first.
