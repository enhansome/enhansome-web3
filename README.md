...
* [ethereum-security](https://github.com/crytic/awesome-ethereum-security) ⭐ 1,483 | 🐛 39 | 📅 2024-08-20 - Curated list of Ethereum security references, guidance, tools, and more.
...
* [Account Abstraction](https://github.com/4337Mafia/awesome-account-abstraction) ⭐ 1,018 | 🐛 787 | 📅 2026-06-09 - Collection of account abstraction resources.
...
* [RPC Nodes](https://github.com/arddluma/awesome-list-rpc-nodes-providers) ⭐ 913 | 🐛 1,279 | 📅 2025-08-28 - Curated list of awesome Node providers and public RPC endpoints.
...
* [x402](https://github.com/xpaysh/awesome-x402) ⭐ 286 | 🐛 485 | 📅 2026-07-28 - Internet-native payment protocol using HTTP 402 status code for blockchain payments.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,932 | 🐛 60 | 🌐 Wikitext | 📅 2026-09-03 - Bitcoin Improvement Proposals.
...
* [Solana Playground](https://github.com/solana-playground/solana-playground) ⭐ 964 | 🐛 115 | 🌐 Rust | 📅 2026-09-07 - Online IDE to quickly develop and deploy Solana programs that runs on web browser.
...
* [Tatum SDK](https://github.com/tatumio/tatum-js) ⭐ 399 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-07 - Tatum SDK is a powerful, feature-rich TypeScript/JavaScript library that streamlines the development of blockchain applications.
...
* [Ophis](https://ophis.fi) - Intent-based DEX aggregator (a CoW Protocol fork) for gasless, MEV-protected swaps across 11 chains, with an MCP server and SDK for AI agents. ([GitHub](https://github.com/ophis-fi/ophis) ⭐ 4 | 🐛 19 | 🌐 Rust | 📅 2026-09-07 · [Docs](https://docs.ophis.fi))
...
* [wagmi](https://github.com/wevm/wagmi) ⭐ 6,745 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-07 - React hooks library for Ethereum.
...
* [solana-web3.js](https://github.com/solana-labs/solana-web3.js) ⭐ 2,754 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-07 - Solana Javascript API built on the Solana JSON RPC API.
* [starknet.js](https://github.com/0xs34n/starknet.js) ⭐ 1,256 | 🐛 40 | 🌐 TypeScript | 📅 2026-09-07 - JavaScript library to interact with Starknet.
* [Hashgraph Online Standards SDK](https://github.com/hashgraph-online/standards-sdk) ⭐ 1,188 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-02 - TypeScript SDK for Hedera Consensus Service standards (HCS-1 through HCS-11), enabling decentralized file storage, NFT metadata, and recursive content on Hedera.
...
* [Tatum JavaScript SDK](https://github.com/tatumio/tatum-js) ⭐ 399 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-07 - Tatum SDK is a powerful, feature-rich TypeScript/JavaScript library that streamlines the development of blockchain applications.
...
* [seaport-js](https://github.com/ProjectOpenSea/seaport-js) ⭐ 270 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 - JavaScript library to interface with the Seaport marketplace.
* [dapparatus](https://github.com/austintgriffith/dapparatus) ⭐ 192 | 🐛 28 | 🌐 JavaScript | 📅 2022-12-08 - Reusable dApp components in React.
* [ensjs](https://github.com/ensdomains/ensjs) ⭐ 157 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-07 - Javascript bindings for the Ethereum Name Service.
...
* [@paritytech/bcts](https://github.com/paritytech/bcts) ⭐ 22 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-07 - TypeSript library implementing common specifications for decentralized applications.
...
* [Formo SDK](https://github.com/getformo/sdk) ⭐ 2 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 - Analytics and attribution SDK for onchain apps.
...
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,231 | 🐛 371 | 🌐 Solidity | 📅 2026-09-07 - The standard for secure blockchain applications.
...
* [avalanchego](https://github.com/ava-labs/avalanchego) ⭐ 2,357 | 🐛 329 | 🌐 Go | 📅 2026-09-07 - Go implementation of an Avalanche node.
...
* [eRPC](https://github.com/erpc/erpc) ⭐ 775 | 🐛 69 | 🌐 Go | 📅 2026-09-07 - Open-source EVM RPC proxy & cache service built to scale horizontally from small traffic to million RPS across many chains, optimized for read-heavy use-cases such as Indexers, Frontends, MEV bots, etc.
...
* [Smart Router](https://github.com/Magma-Devs/smart-router) ⭐ 16 | 🐛 10 | 🌐 Go | 📅 2026-09-07 - Reliability and security layer for blockchain RPC that orchestrates multiple upstreams behind a single endpoint, with automatic failover, data cross-validation, block-aware caching, and observability across EVM and non-EVM networks.
* [geth](https://geth.ethereum.org) - Official Go implementation of the Ethereum protocol.

### C/C++

* [Trust Wallet Core](https://github.com/trustwallet/wallet-core) ⭐ 3,564 | 🐛 184 | 🌐 C++ | 📅 2026-09-07 - Cross-platform, mobile-focused library implementing low-level cryptographic wallet functionality for a high number of blockchains.
* [libethc](https://github.com/mhw0/libethc) ⭐ 72 | 🐛 20 | 🌐 C | 📅 2026-02-18 - Open-source Ethereum library in ANSI C.

### Rust

* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,767 | 🐛 244 | 🌐 Rust | 📅 2026-09-07 - Modular, contributor-friendly and blazing-fast implementation of the Ethereum protocol, in Rust.
...
* [RustChain](https://rustchain.org) - Proof-of-Antiquity blockchain that rewards mining on vintage hardware (PowerPC G4, Pentium 4) with RTC tokens. Features 6-point hardware fingerprinting, Ergo chain anchoring, and an on-chain AI agent economy. ([source code](https://github.com/Scottcjn/rustchain) ⭐ 768 | 🐛 144 | 🌐 Python | 📅 2026-09-07)
* [browser-web3-signer](https://github.com/nikicat/browser-web3-signer) ⭐ 2 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-03 - Sign EVM and TRON transactions and messages with your own browser wallet (MetaMask, Rabby, TronLink) from the CLI or from Rust, TypeScript, and Go programs; the private key never leaves the browser.
...
* [web3.py](https://github.com/ethereum/web3.py) ⭐ 5,525 | 🐛 160 | 🌐 Python | 📅 2026-08-31 - Python interface for interacting with the Ethereum blockchain and ecosystem.
* [Vyper](https://github.com/vyperlang/vyper) ⭐ 5,181 | 🐛 638 | 🌐 Python | 📅 2026-09-07 - Contract-oriented, pythonic programming language that targets EVM.
...
* [evmone](https://github.com/ethereum/evmone) ⭐ 976 | 🐛 161 | 🌐 C++ | 📅 2026-09-07 - C++ implementation of the Ethereum Virtual Machine (EVM), faster.
...
* [dapp-starter-template](https://github.com/jellydn/dapp-starter) ⭐ 327 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-07 - Opinionated Dapp Starter Template.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,356 | 🐛 478 | 🌐 Python | 📅 2026-09-02 - Solidity static analysis framework, a suite of vulnerability detectors, prints visual information about contract details etc.
...
* [OrbitDB](https://github.com/orbitdb/orbit-db) ⭐ 8,801 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-14 - Serverless, distributed, peer-to-peer database.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,356 | 🐛 478 | 🌐 Python | 📅 2026-09-02 - A Solidity static analysis framework.
...
* [@up2itnow0822/agent-wallet-sdk](https://github.com/up2itnow0822/agent-wallet-sdk) ⭐ 11 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-07 - TypeScript SDK for non-custodial AI agent wallets. Handles x402 payments, CCTP V2 cross-chain transfers, Uniswap V3 token swaps, and on-chain spend limits. MIT license.
...
* [Arch Tools](https://archtools.dev) - The first x402 API hub — 58+ AI tools for search, scraping, analysis, and generation with native Coinbase x402 crypto payments on 15+ chains. MCP compatible. [GitHub](https://github.com/Deesmo/Arch-AI-Tools) ⭐ 1 | 🐛 22 | 🌐 HTML | 📅 2026-09-07
...
* [Kuberna Labs](https://github.com/kawacukennedy/kuberna-labs) ⭐ 51 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-02 - Decentralized execution rails for AI agents. Deploy TEE-shielded agents to Ethereum, Solana, NEAR with ERC-7683 intents and zkTLS privacy.
...
* [Solidity](https://github.com/ethereum/solidity) ⭐ 25,725 | 🐛 816 | 🌐 C++ | 📅 2026-09-07 - Solidity is statically typed, contract-oriented, high-level language for implementing smart contracts on the Ethereum platform.
...
* [MetaMask](https://github.com/MetaMask/metamask-extension) ⭐ 13,208 | 🐛 2,851 | 🌐 TypeScript | 📅 2026-09-07 - Browser extension of MetaMask crypto wallet.
* [Chainlink](https://github.com/smartcontractkit/chainlink) ⭐ 8,239 | 🐛 196 | 🌐 Go | 📅 2026-09-07 - Chainlink enhances the possibilities of smart contracts by allowing them to access real-world data.
* [Blockscout](https://github.com/blockscout/blockscout) ⭐ 4,669 | 🐛 178 | 🌐 Elixir | 📅 2026-09-07 - Blockchain explorer for Ethereum based network and a tool for inspecting and analyzing EVM based blockchains.
...
* [Remix](https://github.com/ethereum/remix-project) ⭐ 3,050 | 🐛 913 | 🌐 TypeScript | 📅 2026-09-07 - Browser-based compiler and IDE that enables users to build Ethereum contracts with Solidity language and to debug transactions.
* [Rabby](https://github.com/RabbyHub/Rabby) ⭐ 1,891 | 🐛 146 | 🌐 TypeScript | 📅 2026-09-07 - Browser extension crypto wallet for the DeFi ecosystem that works multi-chain.
...
* [Ethora](https://github.com/dappros/ethora) ⭐ 544 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-07 - Ethora is a low code web3 'super app' engine featuring social sign on, chat, bots, gamification, digital wallet, documents sharing etc. It is easy to customize and build your own app based on Ethora engine.
...
* [Mybucks.online](https://github.com/mybucks-online/app) ⭐ 19 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-07 - Open-source, browser-based and self-custodial wallet that generates a private key from credentials using one-way hash function.
...
Contributions are welcomed! Please read the [contribution guidelines](https://github.com/ahmet/awesome-web3/blob/main/CONTRIBUTING.md) ⭐ 891 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-07 first.
