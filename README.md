...
* [Zero Knowledge](https://github.com/ventali/awesome-zk) ⭐ 1,584 | 🐛 8 | 📅 2024-10-15 - Curated list of awesome ZK resources, libraries, tools and more.
...
* [Account Abstraction](https://github.com/4337Mafia/awesome-account-abstraction) ⭐ 1,015 | 🐛 762 | 📅 2026-06-09 - Collection of account abstraction resources.
...
* [RPC Nodes](https://github.com/arddluma/awesome-list-rpc-nodes-providers) ⭐ 915 | 🐛 1,252 | 📅 2025-08-28 - Curated list of awesome Node providers and public RPC endpoints.
...
* [x402](https://github.com/xpaysh/awesome-x402) ⭐ 277 | 🐛 274 | 📅 2026-07-28 - Internet-native payment protocol using HTTP 402 status code for blockchain payments.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,914 | 🐛 51 | 🌐 Wikitext | 📅 2026-08-15 - Bitcoin Improvement Proposals.
...
* [Solana Playground](https://github.com/solana-playground/solana-playground) ⭐ 955 | 🐛 120 | 🌐 Rust | 📅 2026-08-15 - Online IDE to quickly develop and deploy Solana programs that runs on web browser.
...
* [Ophis](https://ophis.fi) - Intent-based DEX aggregator (a CoW Protocol fork) for gasless, MEV-protected swaps across 11 chains, with an MCP server and SDK for AI agents. ([GitHub](https://github.com/ophis-fi/ophis) ⭐ 3 | 🐛 21 | 🌐 Rust | 📅 2026-08-15 · [Docs](https://docs.ophis.fi))
...
* [Solady](https://github.com/Vectorized/solady) ⭐ 3,360 | 🐛 44 | 🌐 Solidity | 📅 2026-08-02 - Gas optimized Solidity Libraries.
...
* [DeFiMath](https://github.com/MerkleBlue/defimath) ⭐ 17 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-15 - Gas-optimized Solidity library for DeFi math: Black-Scholes option pricing, Greeks, interest rates, and statistics.

### Go

* [avalanchego](https://github.com/ava-labs/avalanchego) ⭐ 2,357 | 🐛 329 | 🌐 Go | 📅 2026-08-15 - Go implementation of an Avalanche node.
...
* [Trust Wallet Core](https://github.com/trustwallet/wallet-core) ⭐ 3,554 | 🐛 168 | 🌐 C++ | 📅 2026-08-07 - Cross-platform, mobile-focused library implementing low-level cryptographic wallet functionality for a high number of blockchains.
* [libethc](https://github.com/mhw0/libethc) ⭐ 72 | 🐛 20 | 🌐 C | 📅 2026-02-18 - Open-source Ethereum library in ANSI C.

### Rust

* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,739 | 🐛 228 | 🌐 Rust | 📅 2026-08-15 - Modular, contributor-friendly and blazing-fast implementation of the Ethereum protocol, in Rust.
...
* [web3.py](https://github.com/ethereum/web3.py) ⭐ 5,519 | 🐛 170 | 🌐 Python | 📅 2026-05-01 - Python interface for interacting with the Ethereum blockchain and ecosystem.
...
* [evmone](https://github.com/ethereum/evmone) ⭐ 974 | 🐛 149 | 🌐 C++ | 📅 2026-08-15 - C++ implementation of the Ethereum Virtual Machine (EVM), faster.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,345 | 🐛 470 | 🌐 Python | 📅 2026-08-12 - Solidity static analysis framework, a suite of vulnerability detectors, prints visual information about contract details etc.
...
* [Gun](https://github.com/amark/gun) ⭐ 19,113 | 🐛 319 | 🌐 JavaScript | 📅 2026-08-01 - Small, easy, and fast protocol for syncing data.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,345 | 🐛 470 | 🌐 Python | 📅 2026-08-12 - A Solidity static analysis framework.
...
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-08-15 - 54 services / 97 endpoints with 37 MCP tools: crypto prices, OHLCV, DeFi yields, technical indicators, DEX swap quotes, prediction markets, trending tokens, gas tracker, and on-chain analytics. 41 x402-paid endpoints ($0.01-$0.05/call, USDC on Base). Remote MCP server, cloud-hosted.
...
* [Kuberna Labs](https://github.com/kawacukennedy/kuberna-labs) ⭐ 49 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-15 - Decentralized execution rails for AI agents. Deploy TEE-shielded agents to Ethereum, Solana, NEAR with ERC-7683 intents and zkTLS privacy.
...
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-08-15 📇 ☁️ - Crypto/financial market data APIs for AI agents. 54 services, 97 endpoints, 37 MCP tools, 41 x402-paid endpoints (USDC on Base). Prices, OHLCV, DeFi yields, DEX quotes, on-chain analytics, social sentiment, gas tracker. Remote MCP server (TypeScript, cloud-hosted).
...
* [Solidity](https://github.com/ethereum/solidity) ⭐ 25,707 | 🐛 790 | 🌐 C++ | 📅 2026-08-15 - Solidity is statically typed, contract-oriented, high-level language for implementing smart contracts on the Ethereum platform.
...
* [MetaMask](https://github.com/MetaMask/metamask-extension) ⭐ 13,200 | 🐛 2,859 | 🌐 TypeScript | 📅 2026-08-15 - Browser extension of MetaMask crypto wallet.
* [Chainlink](https://github.com/smartcontractkit/chainlink) ⭐ 8,236 | 🐛 188 | 🌐 Go | 📅 2026-08-15 - Chainlink enhances the possibilities of smart contracts by allowing them to access real-world data.
...
* [Rainbow](https://github.com/rainbow-me/rainbow) ⭐ 4,380 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-15 - Open source Ethereum wallet.
...
* [Remix](https://github.com/ethereum/remix-project) ⭐ 3,038 | 🐛 906 | 🌐 TypeScript | 📅 2026-08-15 - Browser-based compiler and IDE that enables users to build Ethereum contracts with Solidity language and to debug transactions.
* [Rabby](https://github.com/RabbyHub/Rabby) ⭐ 1,882 | 🐛 136 | 🌐 TypeScript | 📅 2026-08-14 - Browser extension crypto wallet for the DeFi ecosystem that works multi-chain.
...
* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,516 | 🐛 1 | 📅 2026-05-13
