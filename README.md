...
* [Account Abstraction](https://github.com/4337Mafia/awesome-account-abstraction) ⭐ 1,016 | 🐛 784 | 📅 2026-06-09 - Collection of account abstraction resources.
...
* [RPC Nodes](https://github.com/arddluma/awesome-list-rpc-nodes-providers) ⭐ 913 | 🐛 1,277 | 📅 2025-08-28 - Curated list of awesome Node providers and public RPC endpoints.
...
* [x402](https://github.com/xpaysh/awesome-x402) ⭐ 285 | 🐛 474 | 📅 2026-07-28 - Internet-native payment protocol using HTTP 402 status code for blockchain payments.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,932 | 🐛 57 | 🌐 Wikitext | 📅 2026-09-03 - Bitcoin Improvement Proposals.
...
* [DeFi Developer](https://github.com/OffcierCia/DeFi-Developer-Road-Map) ⭐ 10,825 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-16 - Curated Web3.0 Developer handbook which includes a list of the best tools for DApps, development resources and lifehacks.
...
* [Solana Playground](https://github.com/solana-playground/solana-playground) ⭐ 963 | 🐛 115 | 🌐 Rust | 📅 2026-09-05 - Online IDE to quickly develop and deploy Solana programs that runs on web browser.
...
* [Ophis](https://ophis.fi) - Intent-based DEX aggregator (a CoW Protocol fork) for gasless, MEV-protected swaps across 11 chains, with an MCP server and SDK for AI agents. ([GitHub](https://github.com/ophis-fi/ophis) ⭐ 4 | 🐛 21 | 🌐 Rust | 📅 2026-09-05 · [Docs](https://docs.ophis.fi))
...
* [solana-web3.js](https://github.com/solana-labs/solana-web3.js) ⭐ 2,752 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05 - Solana Javascript API built on the Solana JSON RPC API.
...
* [Hashgraph Online Standards SDK](https://github.com/hashgraph-online/standards-sdk) ⭐ 1,185 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-02 - TypeScript SDK for Hedera Consensus Service standards (HCS-1 through HCS-11), enabling decentralized file storage, NFT metadata, and recursive content on Hedera.
...
* [@web3icons/react](https://github.com/0xa3k5/web3icons) ⭐ 274 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-18 - Web3 icons as React components. Includes tokens, coins, networks, wallets.
...
* [ensjs](https://github.com/ensdomains/ensjs) ⭐ 156 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-05 - Javascript bindings for the Ethereum Name Service.
...
* [Formo SDK](https://github.com/getformo/sdk) ⭐ 2 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-05 - Analytics and attribution SDK for onchain apps.
...
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,230 | 🐛 367 | 🌐 Solidity | 📅 2026-09-04 - The standard for secure blockchain applications.
...
* [avalanchego](https://github.com/ava-labs/avalanchego) ⭐ 2,358 | 🐛 328 | 🌐 Go | 📅 2026-09-05 - Go implementation of an Avalanche node.
...
* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,765 | 🐛 237 | 🌐 Rust | 📅 2026-09-05 - Modular, contributor-friendly and blazing-fast implementation of the Ethereum protocol, in Rust.
...
* [Vyper](https://github.com/vyperlang/vyper) ⭐ 5,181 | 🐛 638 | 🌐 Python | 📅 2026-09-05 - Contract-oriented, pythonic programming language that targets EVM.
...
* [evmone](https://github.com/ethereum/evmone) ⭐ 976 | 🐛 160 | 🌐 C++ | 📅 2026-09-05 - C++ implementation of the Ethereum Virtual Machine (EVM), faster.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,356 | 🐛 475 | 🌐 Python | 📅 2026-09-02 - Solidity static analysis framework, a suite of vulnerability detectors, prints visual information about contract details etc.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,356 | 🐛 475 | 🌐 Python | 📅 2026-09-02 - A Solidity static analysis framework.
...
* [@up2itnow0822/agent-wallet-sdk](https://github.com/up2itnow0822/agent-wallet-sdk) ⭐ 10 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-05 - TypeScript SDK for non-custodial AI agent wallets. Handles x402 payments, CCTP V2 cross-chain transfers, Uniswap V3 token swaps, and on-chain spend limits. MIT license.
...
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-09-04 - 54 services / 97 endpoints with 37 MCP tools: crypto prices, OHLCV, DeFi yields, technical indicators, DEX swap quotes, prediction markets, trending tokens, gas tracker, and on-chain analytics. 41 x402-paid endpoints ($0.01-$0.05/call, USDC on Base). Remote MCP server, cloud-hosted.
...
* [web3-docs](https://github.com/dioptx/web3-docs) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2026-05-01 - Local MCP server with a searchable corpus of 1,767 EIPs, BIPs, ADRs, CIPs, and RFCs across 10 chains plus a canonical contract-address registry covering 19 protocols on major EVM chains. SQLite + FTS5, no API keys.
...
* [Web3 Agent Kit](https://github.com/ulsreall/web3-agent-kit) ⭐ 19 | 🐛 12 | 🌐 Python | 📅 2026-08-31 - Open-source Python framework for building autonomous AI agents that interact with DeFi protocols. Multi-chain support (Ethereum, Base, Arbitrum, Optimism, Polygon), LLM-powered reasoning (OpenAI, Anthropic, Groq, DeepSeek), Uniswap V2 swaps, cross-chain bridges (Li.Fi, Socket), token sniper, and portfolio tracking.
...
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 2 | 🌐 Python | 📅 2026-09-04 📇 ☁️ - Crypto/financial market data APIs for AI agents. 54 services, 97 endpoints, 37 MCP tools, 41 x402-paid endpoints (USDC on Base). Prices, OHLCV, DeFi yields, DEX quotes, on-chain analytics, social sentiment, gas tracker. Remote MCP server (TypeScript, cloud-hosted).
...
* [Solidity](https://github.com/ethereum/solidity) ⭐ 25,723 | 🐛 808 | 🌐 C++ | 📅 2026-09-05 - Solidity is statically typed, contract-oriented, high-level language for implementing smart contracts on the Ethereum platform.
* [fabric](https://github.com/hyperledger/fabric) ⭐ 16,712 | 🐛 206 | 🌐 Go | 📅 2026-09-04 - Hyperledger Fabric is enterprise-grade permissioned distributed ledger framework for developing solutions and applications.
...
* [MetaMask](https://github.com/MetaMask/metamask-extension) ⭐ 13,208 | 🐛 2,854 | 🌐 TypeScript | 📅 2026-09-05 - Browser extension of MetaMask crypto wallet.
* [Chainlink](https://github.com/smartcontractkit/chainlink) ⭐ 8,240 | 🐛 196 | 🌐 Go | 📅 2026-09-04 - Chainlink enhances the possibilities of smart contracts by allowing them to access real-world data.
* [Blockscout](https://github.com/blockscout/blockscout) ⭐ 4,668 | 🐛 163 | 🌐 Elixir | 📅 2026-09-05 - Blockchain explorer for Ethereum based network and a tool for inspecting and analyzing EVM based blockchains.
* [Rainbow](https://github.com/rainbow-me/rainbow) ⭐ 4,388 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-04 - Open source Ethereum wallet.
* [Neo](https://github.com/neo-project/neo) ⭐ 3,534 | 🐛 264 | 🌐 C# | 📅 2026-09-05 - Neo is blockchain platform that is open-source and community-driven.
...
* [Rabby](https://github.com/RabbyHub/Rabby) ⭐ 1,890 | 🐛 145 | 🌐 TypeScript | 📅 2026-09-04 - Browser extension crypto wallet for the DeFi ecosystem that works multi-chain.
...
* [Mybucks.online](https://github.com/mybucks-online/app) ⭐ 19 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-05 - Open-source, browser-based and self-custodial wallet that generates a private key from credentials using one-way hash function.
...
Contributions are welcomed! Please read the [contribution guidelines](https://github.com/ahmet/awesome-web3/blob/main/CONTRIBUTING.md) ⭐ 891 | 🐛 34 | 🌐 JavaScript | 📅 2026-08-31 first.
