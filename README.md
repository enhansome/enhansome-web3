...
* [Solidity](https://github.com/bkrem/awesome-solidity) ⭐ 7,046 | 🐛 24 | 📅 2026-08-18 - Curated list of awesome Solidity resources, libraries, tools and more.
* [Blockchain](https://github.com/yjjnls/awesome-blockchain) ⭐ 3,627 | 🐛 52 | 🌐 Go | 📅 2024-03-22 - Curated list of resources for the development and applications of blockchain.
...
* [Account Abstraction](https://github.com/4337Mafia/awesome-account-abstraction) ⭐ 1,016 | 🐛 768 | 📅 2026-06-09 - Collection of account abstraction resources.
...
* [RPC Nodes](https://github.com/arddluma/awesome-list-rpc-nodes-providers) ⭐ 914 | 🐛 1,259 | 📅 2025-08-28 - Curated list of awesome Node providers and public RPC endpoints.
* [Ethereum](https://github.com/bekatom/awesome-ethereum) ⭐ 912 | 🐛 33 | 📅 2025-04-09 - Awesome Ethereum & Dapps Resources.
...
* [x402](https://github.com/xpaysh/awesome-x402) ⭐ 283 | 🐛 319 | 📅 2026-07-28 - Internet-native payment protocol using HTTP 402 status code for blockchain payments.
...
* [BIPs](https://github.com/bitcoin/bips) ⭐ 10,922 | 🐛 53 | 🌐 Wikitext | 📅 2026-08-20 - Bitcoin Improvement Proposals.
...
* [DeFi Developer](https://github.com/OffcierCia/DeFi-Developer-Road-Map) ⭐ 10,812 | 🐛 5 | 🌐 JavaScript | 📅 2026-08-16 - Curated Web3.0 Developer handbook which includes a list of the best tools for DApps, development resources and lifehacks.
...
* [Yul By Example](https://github.com/Perelyn-sama/yul_by_example) ⭐ 253 | 🐛 0 | 🌐 HTML | 📅 2024-08-27 - Basic examples on Yul.
...
* [Solana Playground](https://github.com/solana-playground/solana-playground) ⭐ 957 | 🐛 118 | 🌐 Rust | 📅 2026-08-21 - Online IDE to quickly develop and deploy Solana programs that runs on web browser.
...
* [WalletLink](https://github.com/walletlink/walletlink) ⭐ 1,757 | 🐛 84 | 🌐 TypeScript | 📅 2026-04-30 - Open protocol that lets users connect their mobile wallets to your DApp.
...
* [Ophis](https://ophis.fi) - Intent-based DEX aggregator (a CoW Protocol fork) for gasless, MEV-protected swaps across 11 chains, with an MCP server and SDK for AI agents. ([GitHub](https://github.com/ophis-fi/ophis) ⭐ 3 | 🐛 20 | 🌐 Rust | 📅 2026-08-21 · [Docs](https://docs.ophis.fi))
...
* [ethers.js](https://github.com/ethers-io/ethers.js/) ⭐ 8,715 | 🐛 661 | 🌐 TypeScript | 📅 2026-06-18 - Complete Ethereum wallet implementation and utilities in JavaScript (and TypeScript).
* [js-ipfs](https://github.com/ipfs/js-ipfs) ⚠️ Archived - IPFS implementation in JavaScript.
* [wagmi](https://github.com/wevm/wagmi) ⭐ 6,744 | 🐛 22 | 🌐 TypeScript | 📅 2026-08-18 - React hooks library for Ethereum.
* [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 5,997 | 🐛 53 | 🌐 JavaScript | 📅 2026-02-17 - Bitcoin library for node.js and browsers.
...
* [solana-web3.js](https://github.com/solana-labs/solana-web3.js) ⭐ 2,749 | 🐛 28 | 🌐 TypeScript | 📅 2026-08-21 - Solana Javascript API built on the Solana JSON RPC API.
* [starknet.js](https://github.com/0xs34n/starknet.js) ⭐ 1,257 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-21 - JavaScript library to interact with Starknet.
...
* [Hashgraph Online Standards SDK](https://github.com/hashgraph-online/standards-sdk) ⭐ 1,003 | 🐛 13 | 🌐 TypeScript | 📅 2026-05-08 - TypeScript SDK for Hedera Consensus Service standards (HCS-1 through HCS-11), enabling decentralized file storage, NFT metadata, and recursive content on Hedera.
...
* [js-algorand-sdk](https://github.com/algorand/js-algorand-sdk) ⭐ 298 | 🐛 60 | 🌐 TypeScript | 📅 2026-08-20 - AlgoSDK is the official JavaScript library for communicating with the Algorand network.
* [seaport-js](https://github.com/ProjectOpenSea/seaport-js) ⭐ 269 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-17 - JavaScript library to interface with the Seaport marketplace.
* [@web3icons/react](https://github.com/0xa3k5/web3icons) ⭐ 267 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-18 - Web3 icons as React components. Includes tokens, coins, networks, wallets.
...
* [Formo SDK](https://github.com/getformo/sdk) ⭐ 2 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-21 - Analytics and attribution SDK for onchain apps.
...
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,223 | 🐛 370 | 🌐 Solidity | 📅 2026-08-21 - The standard for secure blockchain applications.
* [Solady](https://github.com/Vectorized/solady) ⭐ 3,361 | 🐛 45 | 🌐 Solidity | 📅 2026-08-17 - Gas optimized Solidity Libraries.
...
* [CREATE2 Deployer](https://github.com/pcaversaccio/create2deployer) ⭐ 306 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-19 - Helper smart contract to make easier and safer usage of the `CREATE2` EVM opcode.
...
* [avalanchego](https://github.com/ava-labs/avalanchego) ⭐ 2,356 | 🐛 338 | 🌐 Go | 📅 2026-08-21 - Go implementation of an Avalanche node.
* [tss-lib](https://github.com/bnb-chain/tss-lib) ⭐ 1,035 | 🐛 67 | 🌐 Go | 📅 2026-04-09 - This is an implementation of multi-party {t,n}-threshold ECDSA (Elliptic Curve Digital Signature Algorithm) based on Gennaro and Goldfeder CCS 2018 1 and EdDSA (Edwards-curve Digital Signature Algorithm)
* [eRPC](https://github.com/erpc/erpc) ⭐ 760 | 🐛 69 | 🌐 Go | 📅 2026-08-21 - Open-source EVM RPC proxy & cache service built to scale horizontally from small traffic to million RPS across many chains, optimized for read-heavy use-cases such as Indexers, Frontends, MEV bots, etc.
...
* [Smart Router](https://github.com/Magma-Devs/smart-router) ⭐ 16 | 🐛 7 | 🌐 Go | 📅 2026-08-21 - Reliability and security layer for blockchain RPC that orchestrates multiple upstreams behind a single endpoint, with automatic failover, data cross-validation, block-aware caching, and observability across EVM and non-EVM networks.
* [geth](https://geth.ethereum.org) - Official Go implementation of the Ethereum protocol.

### C/C++

* [Trust Wallet Core](https://github.com/trustwallet/wallet-core) ⭐ 3,558 | 🐛 174 | 🌐 C++ | 📅 2026-08-21 - Cross-platform, mobile-focused library implementing low-level cryptographic wallet functionality for a high number of blockchains.
* [libethc](https://github.com/mhw0/libethc) ⭐ 72 | 🐛 20 | 🌐 C | 📅 2026-02-18 - Open-source Ethereum library in ANSI C.

### Rust

* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,744 | 🐛 215 | 🌐 Rust | 📅 2026-08-21 - Modular, contributor-friendly and blazing-fast implementation of the Ethereum protocol, in Rust.
...
* [dexscraper](https://github.com/vincentkoc/dexscraper) ⭐ 114 | 🐛 0 | 🌐 Python | 📅 2026-04-30 - Python SDK and CLI for extracting real-time DexScreener market data over WebSocket and API.
...
* [evmone](https://github.com/ethereum/evmone) ⭐ 974 | 🐛 153 | 🌐 C++ | 📅 2026-08-21 - C++ implementation of the Ethereum Virtual Machine (EVM), faster.
...
* [dapp-starter-template](https://github.com/jellydn/dapp-starter) ⭐ 327 | 🐛 12 | 🌐 TypeScript | 📅 2026-08-21 - Opinionated Dapp Starter Template.
...
* [solidity-coverage](https://github.com/sc-forks/solidity-coverage) ⭐ 1,002 | 🐛 42 | 🌐 JavaScript | 📅 2025-12-11 - Code coverage for Solidity smart-contracts.
...
* [prb-test](https://github.com/PaulRBerg/prb-test) ⭐ 183 | 🐛 3 | 🌐 Solidity | 📅 2024-12-26 - Modern collection of testing assertions and logging utilities for Solidity.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,347 | 🐛 473 | 🌐 Python | 📅 2026-08-19 - Solidity static analysis framework, a suite of vulnerability detectors, prints visual information about contract details etc.
...
* [Gun](https://github.com/amark/gun) ⭐ 19,123 | 🐛 321 | 🌐 JavaScript | 📅 2026-08-01 - Small, easy, and fast protocol for syncing data.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,347 | 🐛 473 | 🌐 Python | 📅 2026-08-19 - A Solidity static analysis framework.
* [Mythril](https://github.com/ConsenSys/mythril) ⭐ 4,263 | 🐛 130 | 🌐 Python | 📅 2026-04-27 - Open-source EVM bytecode security analysis tool.
...
* [EVMole](https://github.com/cdump/evmole) ⭐ 460 | 🐛 2 | 🌐 Rust | 📅 2026-08-15 - Extracts function selectors from EVM bytecode, even for unverified contracts.
...
* [@up2itnow0822/agent-wallet-sdk](https://github.com/up2itnow0822/agent-wallet-sdk) ⭐ 9 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-15 - TypeScript SDK for non-custodial AI agent wallets. Handles x402 payments, CCTP V2 cross-chain transfers, Uniswap V3 token swaps, and on-chain spend limits. MIT license.
...
* [Arch Tools](https://archtools.dev) - The first x402 API hub — 58+ AI tools for search, scraping, analysis, and generation with native Coinbase x402 crypto payments on 15+ chains. MCP compatible. [GitHub](https://github.com/Deesmo/Arch-AI-Tools) ⭐ 1 | 🐛 15 | 🌐 HTML | 📅 2026-08-21
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2026-08-21 - 54 services / 97 endpoints with 37 MCP tools: crypto prices, OHLCV, DeFi yields, technical indicators, DEX swap quotes, prediction markets, trending tokens, gas tracker, and on-chain analytics. 41 x402-paid endpoints ($0.01-$0.05/call, USDC on Base). Remote MCP server, cloud-hosted.
...
* [Kuberna Labs](https://github.com/kawacukennedy/kuberna-labs) ⭐ 51 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-21 - Decentralized execution rails for AI agents. Deploy TEE-shielded agents to Ethereum, Solana, NEAR with ERC-7683 intents and zkTLS privacy.
* [web3-docs](https://github.com/dioptx/web3-docs) ⭐ 25 | 🐛 0 | 🌐 Python | 📅 2026-05-01 - Local MCP server with a searchable corpus of 1,767 EIPs, BIPs, ADRs, CIPs, and RFCs across 10 chains plus a canonical contract-address registry covering 19 protocols on major EVM chains. SQLite + FTS5, no API keys.
* [dRPC Agent Skills](https://github.com/drpcorg/drpc-agent-skills) ⭐ 22 | 🐛 2 | 🌐 TypeScript | 📅 2026-06-21 - Read-only on-chain data for AI agents via DRPC's node network. Covers all major EVM networks and Solana. Free API key at drpc.org.
* [Hive Intelligence](https://github.com/hive-intel/hive-crypto-mcp) ⭐ 19 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-18 🎖️ 📇 ☁️ 🏠 - Institutional-grade crypto market infrastructure for AI — live prices, DeFi, wallets, and token risk through a managed MCP, REST API, or CLI.
...
* [AgentServices](https://github.com/vbkotecha/aiservices-api) ⭐ 1 | 🐛 1 | 🌐 Python | 📅 2026-08-21 📇 ☁️ - Crypto/financial market data APIs for AI agents. 54 services, 97 endpoints, 37 MCP tools, 41 x402-paid endpoints (USDC on Base). Prices, OHLCV, DeFi yields, DEX quotes, on-chain analytics, social sentiment, gas tracker. Remote MCP server (TypeScript, cloud-hosted).
...
* [Solidity](https://github.com/ethereum/solidity) ⭐ 25,706 | 🐛 794 | 🌐 C++ | 📅 2026-08-21 - Solidity is statically typed, contract-oriented, high-level language for implementing smart contracts on the Ethereum platform.
* [fabric](https://github.com/hyperledger/fabric) ⭐ 16,702 | 🐛 205 | 🌐 Go | 📅 2026-08-05 - Hyperledger Fabric is enterprise-grade permissioned distributed ledger framework for developing solutions and applications.
...
* [MetaMask](https://github.com/MetaMask/metamask-extension) ⭐ 13,204 | 🐛 2,837 | 🌐 TypeScript | 📅 2026-08-21 - Browser extension of MetaMask crypto wallet.
* [Chainlink](https://github.com/smartcontractkit/chainlink) ⭐ 8,236 | 🐛 189 | 🌐 Go | 📅 2026-08-21 - Chainlink enhances the possibilities of smart contracts by allowing them to access real-world data.
* [Blockscout](https://github.com/blockscout/blockscout) ⭐ 4,639 | 🐛 160 | 🌐 Elixir | 📅 2026-08-21 - Blockchain explorer for Ethereum based network and a tool for inspecting and analyzing EVM based blockchains.
* [Rainbow](https://github.com/rainbow-me/rainbow) ⭐ 4,381 | 🐛 29 | 🌐 TypeScript | 📅 2026-08-21 - Open source Ethereum wallet.
* [Neo](https://github.com/neo-project/neo) ⭐ 3,535 | 🐛 256 | 🌐 C# | 📅 2026-08-09 - Neo is blockchain platform that is open-source and community-driven.
* [Remix](https://github.com/ethereum/remix-project) ⭐ 3,041 | 🐛 904 | 🌐 TypeScript | 📅 2026-08-21 - Browser-based compiler and IDE that enables users to build Ethereum contracts with Solidity language and to debug transactions.
* [Rabby](https://github.com/RabbyHub/Rabby) ⭐ 1,885 | 🐛 144 | 🌐 TypeScript | 📅 2026-08-21 - Browser extension crypto wallet for the DeFi ecosystem that works multi-chain.
...
* [Ethora](https://github.com/dappros/ethora) ⭐ 542 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-21 - Ethora is a low code web3 'super app' engine featuring social sign on, chat, bots, gamification, digital wallet, documents sharing etc. It is easy to customize and build your own app based on Ethora engine.
...
* [Build a blockchain from scratch in Go with gRPC](https://github.com/volodymyrprokopyuk/go-blockchain) ⭐ 553 | 🐛 0 | 🌐 Go | 📅 2025-08-17 - The foundational and practical guide for effectively learning and progressively building a blockchain from scratch in Go with gRPC
...
* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,516 | 🐛 2 | 📅 2026-05-13
...
Contributions are welcomed! Please read the [contribution guidelines](https://github.com/ahmet/awesome-web3/blob/main/CONTRIBUTING.md) ⭐ 887 | 🐛 25 | 🌐 JavaScript | 📅 2026-08-20 first.
