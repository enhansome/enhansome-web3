...
* [Solidity](https://github.com/bkrem/awesome-solidity) ⭐ 7,052 | 🐛 14 | 📅 2026-09-25 - Curated list of awesome Solidity resources, libraries, tools and more.
...
* [Web3 Security](https://github.com/Anugrahsr/Awesome-web3-Security) ⭐ 1,624 | 🐛 17 | 📅 2026-03-01 - Curated list of web3 security materials and resources for pentesters and bug hunters.
...
* [Account Abstraction](https://github.com/4337Mafia/awesome-account-abstraction) ⭐ 1,020 | 🐛 806 | 📅 2026-06-09 - Collection of account abstraction resources.
...
* [RPC Nodes](https://github.com/arddluma/awesome-list-rpc-nodes-providers) ⭐ 916 | 🐛 1,300 | 📅 2025-08-28 - Curated list of awesome Node providers and public RPC endpoints.
...
* [x402](https://github.com/xpaysh/awesome-x402) ⭐ 291 | 🐛 613 | 📅 2026-07-28 - Internet-native payment protocol using HTTP 402 status code for blockchain payments.
...
* [DeFi Developer](https://github.com/OffcierCia/DeFi-Developer-Road-Map) ⭐ 10,837 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-16 - Curated Web3.0 Developer handbook which includes a list of the best tools for DApps, development resources and lifehacks.
...
* [Solana Playground](https://github.com/solana-playground/solana-playground) ⭐ 971 | 🐛 116 | 🌐 Rust | 📅 2026-09-25 - Online IDE to quickly develop and deploy Solana programs that runs on web browser.
...
* [Ophis](https://ophis.fi) - Intent-based DEX aggregator (a CoW Protocol fork) for gasless, MEV-protected swaps across 11 chains, with an MCP server and SDK for AI agents. ([GitHub](https://github.com/ophis-fi/ophis) ⭐ 4 | 🐛 26 | 🌐 Rust | 📅 2026-09-25 · [Docs](https://docs.ophis.fi))
...
* [wagmi](https://github.com/wevm/wagmi) ⭐ 6,753 | 🐛 35 | 🌐 TypeScript | 📅 2026-09-07 - React hooks library for Ethereum.
* [BitcoinJS](https://github.com/bitcoinjs/bitcoinjs-lib) ⭐ 6,002 | 🐛 56 | 🌐 JavaScript | 📅 2026-02-17 - Bitcoin library for node.js and browsers.
...
* [solana-web3.js](https://github.com/solana-labs/solana-web3.js) ⭐ 2,757 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-25 - Solana Javascript API built on the Solana JSON RPC API.
* [starknet.js](https://github.com/0xs34n/starknet.js) ⭐ 1,255 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-25 - JavaScript library to interact with Starknet.
* [Hashgraph Online Standards SDK](https://github.com/hashgraph-online/standards-sdk) ⭐ 1,229 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-24 - TypeScript SDK for Hedera Consensus Service standards (HCS-1 through HCS-11), enabling decentralized file storage, NFT metadata, and recursive content on Hedera.
...
* [avalanchejs](https://github.com/ava-labs/avalanchejs) ⭐ 357 | 🐛 23 | 🌐 TypeScript | 📅 2026-09-25 - JavaScript Library for interfacing with the Avalanche Platform.
* [sequence.js](https://github.com/0xsequence/sequence.js) ⭐ 318 | 🐛 32 | 🌐 TypeScript | 📅 2026-09-25 - Sequence is modular web3 stack and smart wallet for Ethereum chains.
...
* [@web3icons/react](https://github.com/0xa3k5/web3icons) ⭐ 283 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-15 - Web3 icons as React components. Includes tokens, coins, networks, wallets.
...
* [bee-js](https://github.com/ethersphere/bee-js) ⭐ 67 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-25 - Javascript client library for connecting to Bee decentralised storage.
...
* [OpenZeppelin](https://github.com/OpenZeppelin/openzeppelin-contracts) ⭐ 27,255 | 🐛 358 | 🌐 Solidity | 📅 2026-09-25 - The standard for secure blockchain applications.
...
* [CREATE2 Deployer](https://github.com/pcaversaccio/create2deployer) ⭐ 308 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-25 - Helper smart contract to make easier and safer usage of the `CREATE2` EVM opcode.
...
* [avalanchego](https://github.com/ava-labs/avalanchego) ⭐ 2,358 | 🐛 353 | 🌐 Go | 📅 2026-09-25 - Go implementation of an Avalanche node.
...
* [eRPC](https://github.com/erpc/erpc) ⭐ 787 | 🐛 75 | 🌐 Go | 📅 2026-09-24 - Open-source EVM RPC proxy & cache service built to scale horizontally from small traffic to million RPS across many chains, optimized for read-heavy use-cases such as Indexers, Frontends, MEV bots, etc.
...
* [Smart Router](https://github.com/Magma-Devs/smart-router) ⭐ 16 | 🐛 32 | 🌐 Go | 📅 2026-09-25 - Reliability and security layer for blockchain RPC that orchestrates multiple upstreams behind a single endpoint, with automatic failover, data cross-validation, block-aware caching, and observability across EVM and non-EVM networks.
* [geth](https://geth.ethereum.org) - Official Go implementation of the Ethereum protocol.

### C/C++

* [Trust Wallet Core](https://github.com/trustwallet/wallet-core) ⭐ 3,571 | 🐛 184 | 🌐 C++ | 📅 2026-09-24 - Cross-platform, mobile-focused library implementing low-level cryptographic wallet functionality for a high number of blockchains.
* [libethc](https://github.com/mhw0/libethc) ⭐ 72 | 🐛 20 | 🌐 C | 📅 2026-02-18 - Open-source Ethereum library in ANSI C.

### Rust

* [Reth](https://github.com/paradigmxyz/reth) ⭐ 5,788 | 🐛 287 | 🌐 Rust | 📅 2026-09-25 - Modular, contributor-friendly and blazing-fast implementation of the Ethereum protocol, in Rust.
...
* [web3.py](https://github.com/ethereum/web3.py) ⭐ 5,533 | 🐛 165 | 🌐 Python | 📅 2026-09-25 - Python interface for interacting with the Ethereum blockchain and ecosystem.
* [Vyper](https://github.com/vyperlang/vyper) ⭐ 5,183 | 🐛 624 | 🌐 Python | 📅 2026-09-24 - Contract-oriented, pythonic programming language that targets EVM.
...
* [evmone](https://github.com/ethereum/evmone) ⭐ 976 | 🐛 170 | 🌐 C++ | 📅 2026-09-25 - C++ implementation of the Ethereum Virtual Machine (EVM), faster.
...
* [Slither](https://github.com/crytic/slither) ⭐ 6,373 | 🐛 479 | 🌐 Python | 📅 2026-09-23 - Solidity static analysis framework, a suite of vulnerability detectors, prints visual information about contract details etc.
* [solhint](https://github.com/protofire/solhint) ⭐ 1,126 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-25 - Solidity linter providing Security and Style Guide validations.
...
* [Solidity](https://github.com/ethereum/solidity) ⭐ 25,742 | 🐛 826 | 🌐 C++ | 📅 2026-09-25 - Solidity is statically typed, contract-oriented, high-level language for implementing smart contracts on the Ethereum platform.
* [fabric](https://github.com/hyperledger/fabric) ⭐ 16,730 | 🐛 206 | 🌐 Go | 📅 2026-09-25 - Hyperledger Fabric is enterprise-grade permissioned distributed ledger framework for developing solutions and applications.
...
* [MetaMask](https://github.com/MetaMask/metamask-extension) ⭐ 13,222 | 🐛 2,815 | 🌐 TypeScript | 📅 2026-09-25 - Browser extension of MetaMask crypto wallet.
* [Chainlink](https://github.com/smartcontractkit/chainlink) ⭐ 8,248 | 🐛 175 | 🌐 Go | 📅 2026-09-25 - Chainlink enhances the possibilities of smart contracts by allowing them to access real-world data.
* [Blockscout](https://github.com/blockscout/blockscout) ⭐ 4,716 | 🐛 170 | 🌐 Elixir | 📅 2026-09-25 - Blockchain explorer for Ethereum based network and a tool for inspecting and analyzing EVM based blockchains.
* [Rainbow](https://github.com/rainbow-me/rainbow) ⭐ 4,396 | 🐛 31 | 🌐 TypeScript | 📅 2026-09-25 - Open source Ethereum wallet.
* [Neo](https://github.com/neo-project/neo) ⭐ 3,536 | 🐛 262 | 🌐 C# | 📅 2026-09-24 - Neo is blockchain platform that is open-source and community-driven.
* [Remix](https://github.com/ethereum/remix-project) ⭐ 3,057 | 🐛 916 | 🌐 TypeScript | 📅 2026-09-25 - Browser-based compiler and IDE that enables users to build Ethereum contracts with Solidity language and to debug transactions.
* [Rabby](https://github.com/RabbyHub/Rabby) ⭐ 1,898 | 🐛 138 | 🌐 TypeScript | 📅 2026-09-24 - Browser extension crypto wallet for the DeFi ecosystem that works multi-chain.
...
* [Ethora](https://github.com/dappros/ethora) ⭐ 547 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-25 - Ethora is a low code web3 'super app' engine featuring social sign on, chat, bots, gamification, digital wallet, documents sharing etc. It is easy to customize and build your own app based on Ethora engine.
...
* [Vocdoni](https://github.com/vocdoni/vocdoni-node) ⭐ 92 | 🐛 83 | 🌐 Go | 📅 2026-09-25 - Decentralized voting protocol with an AGPL-3.0 Go implementation for verifiable organizational elections.
...
* [Vultisig](https://github.com/vultisig/vultisig-windows) ⭐ 20 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-25 - Seedless self-custodial multi-chain wallet secured by MPC threshold signatures; this repo builds the Vultisig desktop app and the Chrome extension.
...
* [Mastering Ethereum](https://github.com/ethereumbook/ethereumbook) ⭐ 21,529 | 🐛 1 | 📅 2026-09-22
